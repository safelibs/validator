...
static unsigned char afl_fuzz_testcase_buf[1];
static int
afl_loop_once(int max_iterations)
{
...
#define __AFL_FUZZ_TESTCASE_BUF afl_fuzz_testcase_buf
#define __AFL_FUZZ_TESTCASE_LEN 0
#define __AFL_LOOP(x) afl_loop_once(x)
#endif
