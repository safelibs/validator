#!/usr/bin/env bash
# @testcase: usage-python-libarchive-c-zip-long-path
# @title: python libarchive zip long path
# @description: Exercises python libarchive zip long path through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
...
case_id="usage-python-libarchive-c-zip-long-path"
tmpdir=$(mktemp -d)
