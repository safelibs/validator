#!/usr/bin/env bash
# @testcase: usage-python-libarchive-c-lzop-filter
# @title: python-libarchive-c lzop filter
# @description: Creates an lzop-filtered tar archive and reads it back through python-libarchive-c.
# @timeout: 180
...
case_id="usage-python-libarchive-c-lzop-filter"
tmpdir=$(mktemp -d)
