#!/usr/bin/env bash
# @testcase: usage-python-libarchive-c-bzip2-filter
# @title: python-libarchive-c bzip2 filter
# @description: Creates a bzip2-filtered tar archive and reads it through python-libarchive-c.
# @timeout: 180
...
case_id="usage-python-libarchive-c-bzip2-filter"
tmpdir=$(mktemp -d)
