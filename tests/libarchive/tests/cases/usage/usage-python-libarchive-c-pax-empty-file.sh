#!/usr/bin/env bash
# @testcase: usage-python-libarchive-c-pax-empty-file
# @title: python libarchive pax empty file
# @description: Exercises python libarchive pax empty file through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
...
case_id="usage-python-libarchive-c-pax-empty-file"
tmpdir=$(mktemp -d)
