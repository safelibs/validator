#!/usr/bin/env bash
# @testcase: usage-python-libarchive-c-empty-file
# @title: python-libarchive-c empty file
# @description: Writes and reads an empty file entry through python-libarchive-c.
# @timeout: 180
...
case_id="usage-python-libarchive-c-empty-file"
tmpdir=$(mktemp -d)
