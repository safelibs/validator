#!/usr/bin/env bash
# @testcase: usage-python-libarchive-c-tar-dotfile
# @title: python-libarchive-c tar dotfile
# @description: Writes and reads a tar archive containing a dotfile through python-libarchive-c.
# @timeout: 180
...
case_id="usage-python-libarchive-c-tar-dotfile"
tmpdir=$(mktemp -d)
