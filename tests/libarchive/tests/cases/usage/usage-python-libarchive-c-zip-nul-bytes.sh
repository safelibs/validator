#!/usr/bin/env bash
# @testcase: usage-python-libarchive-c-zip-nul-bytes
# @title: python libarchive zip NUL bytes
# @description: Exercises python libarchive zip nul bytes through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
...
case_id="usage-python-libarchive-c-zip-nul-bytes"
tmpdir=$(mktemp -d)
