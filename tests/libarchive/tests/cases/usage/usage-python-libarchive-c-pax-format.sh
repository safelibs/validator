#!/usr/bin/env bash
# @testcase: usage-python-libarchive-c-pax-format
# @title: python-libarchive-c pax format
# @description: Writes a pax archive with python-libarchive-c and verifies path and body data.
# @timeout: 180
...
case_id="usage-python-libarchive-c-pax-format"
tmpdir=$(mktemp -d)
