#!/usr/bin/env bash
# @testcase: usage-python-libarchive-c-batch11-tar-large-blocks
# @title: libarchive tar large blocks
# @description: Writes and reads a large tar member through python-libarchive-c.
# @timeout: 180
...
case_id="usage-python-libarchive-c-batch11-tar-large-blocks"
tmpdir=$(mktemp -d)
