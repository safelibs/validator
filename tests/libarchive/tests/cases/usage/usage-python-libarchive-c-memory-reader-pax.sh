#!/usr/bin/env bash
# @testcase: usage-python-libarchive-c-memory-reader-pax
# @title: python libarchive pax memory reader
# @description: Exercises python libarchive pax memory reader through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
...
case_id="usage-python-libarchive-c-memory-reader-pax"
tmpdir=$(mktemp -d)
