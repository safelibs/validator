#!/usr/bin/env bash
# @testcase: usage-python-libarchive-c-batch11-bzip2-memory-reader
# @title: libarchive bzip2 memory reader
# @description: Reads a bzip2-filtered tar archive from memory through python-libarchive-c.
# @timeout: 180
...
case_id="usage-python-libarchive-c-batch11-bzip2-memory-reader"
tmpdir=$(mktemp -d)
