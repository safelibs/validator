#!/usr/bin/env bash
# @testcase: usage-python-libarchive-c-ustar-format
# @title: python-libarchive-c ustar format
# @description: Writes a ustar archive with python-libarchive-c and verifies the stored file payload.
# @timeout: 180
...
case_id="usage-python-libarchive-c-ustar-format"
tmpdir=$(mktemp -d)
