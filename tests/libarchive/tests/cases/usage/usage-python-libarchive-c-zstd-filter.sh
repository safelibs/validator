#!/usr/bin/env bash
# @testcase: usage-python-libarchive-c-zstd-filter
# @title: python-libarchive-c zstd filter
# @description: Creates a zstd-filtered tar archive and reads it through python-libarchive-c.
# @timeout: 180
...
case_id="usage-python-libarchive-c-zstd-filter"
tmpdir=$(mktemp -d)
