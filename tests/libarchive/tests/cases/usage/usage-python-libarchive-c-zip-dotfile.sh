#!/usr/bin/env bash
# @testcase: usage-python-libarchive-c-zip-dotfile
# @title: python-libarchive-c zip dotfile
# @description: Writes and reads a zip archive containing a dotfile through python-libarchive-c.
# @timeout: 180
...
case_id="usage-python-libarchive-c-zip-dotfile"
tmpdir=$(mktemp -d)
