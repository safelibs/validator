#!/usr/bin/env bash
# @testcase: usage-python-libarchive-c-batch11-zip-json-payload
# @title: libarchive zip JSON payload
# @description: Roundtrips a JSON byte payload in a zip archive through python-libarchive-c.
# @timeout: 180
...
case_id="usage-python-libarchive-c-batch11-zip-json-payload"
tmpdir=$(mktemp -d)
