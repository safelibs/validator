#!/usr/bin/env bash
# @testcase: usage-python-libarchive-c-xz-filter
# @title: python-libarchive-c xz filter
# @description: Creates an xz-filtered tar archive and reads it through python-libarchive-c.
# @timeout: 180
...
case_id="usage-python-libarchive-c-xz-filter"
tmpdir=$(mktemp -d)
