#!/usr/bin/env bash
# @testcase: usage-python-libarchive-c-lzma-filter
# @title: python-libarchive-c lzma filter
# @description: Creates an lzma-filtered tar archive and reads it back through python-libarchive-c.
# @timeout: 180
...
case_id="usage-python-libarchive-c-lzma-filter"
tmpdir=$(mktemp -d)
