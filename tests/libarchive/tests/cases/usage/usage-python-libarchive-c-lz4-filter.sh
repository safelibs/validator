#!/usr/bin/env bash
# @testcase: usage-python-libarchive-c-lz4-filter
# @title: python-libarchive-c lz4 filter
# @description: Creates an lz4-filtered tar archive and reads it back through python-libarchive-c.
# @timeout: 180
...
case_id="usage-python-libarchive-c-lz4-filter"
tmpdir=$(mktemp -d)
