#!/usr/bin/env bash
# @testcase: usage-python-libarchive-c-large-entry
# @title: python-libarchive-c large entry
# @description: Archives a larger in-memory payload and checks size-preserving extraction.
# @timeout: 180
...
case_id="usage-python-libarchive-c-large-entry"
tmpdir=$(mktemp -d)
