#!/usr/bin/env bash
# @testcase: usage-python-libarchive-c-spaced-name
# @title: python-libarchive-c spaced name
# @description: Stores a path containing spaces and verifies python-libarchive-c preserves it.
# @timeout: 180
...
case_id="usage-python-libarchive-c-spaced-name"
tmpdir=$(mktemp -d)
