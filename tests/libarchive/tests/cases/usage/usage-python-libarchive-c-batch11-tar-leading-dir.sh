#!/usr/bin/env bash
# @testcase: usage-python-libarchive-c-batch11-tar-leading-dir
# @title: libarchive tar leading directory
# @description: Roundtrips a leading directory path through python-libarchive-c.
# @timeout: 180
...
case_id="usage-python-libarchive-c-batch11-tar-leading-dir"
tmpdir=$(mktemp -d)
