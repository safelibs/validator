#!/usr/bin/env bash
# @testcase: usage-python-libarchive-c-memory-reader-cpio
# @title: python libarchive cpio memory reader
# @description: Exercises python libarchive cpio memory reader through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
...
case_id="usage-python-libarchive-c-memory-reader-cpio"
tmpdir=$(mktemp -d)
