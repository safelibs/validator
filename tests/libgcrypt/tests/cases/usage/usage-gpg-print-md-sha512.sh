#!/usr/bin/env bash
# @testcase: usage-gpg-print-md-sha512
# @title: gpg SHA512 digest
# @description: Computes a SHA512 message digest with gpg and checks digest output.
# @timeout: 180
...
case_id="usage-gpg-print-md-sha512"
tmpdir=$(mktemp -d)
