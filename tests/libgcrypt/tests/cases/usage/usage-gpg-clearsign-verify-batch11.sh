#!/usr/bin/env bash
# @testcase: usage-gpg-clearsign-verify-batch11
# @title: gpg clearsign verify
# @description: Creates and verifies a cleartext signature with gpg.
# @timeout: 240
...
case_id="usage-gpg-clearsign-verify-batch11"
tmpdir=$(mktemp -d)
