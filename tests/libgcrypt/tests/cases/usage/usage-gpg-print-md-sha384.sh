#!/usr/bin/env bash
# @testcase: usage-gpg-print-md-sha384
# @title: gpg SHA384 digest
# @description: Computes a SHA384 message digest with gpg and checks digest output.
# @timeout: 180
...
case_id="usage-gpg-print-md-sha384"
tmpdir=$(mktemp -d)
