#!/usr/bin/env bash
# @testcase: usage-gpg-detached-sign-verify
# @title: GnuPG detached signature
# @description: Generates a signing key, creates a detached signature, and verifies it.
# @timeout: 180
# @tags: usage, crypto
# @client: gpg
...
case_id="usage-gpg-detached-sign-verify"
tmpdir=$(mktemp -d)
