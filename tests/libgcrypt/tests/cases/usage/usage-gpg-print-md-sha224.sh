#!/usr/bin/env bash
# @testcase: usage-gpg-print-md-sha224
# @title: gpg SHA224 digest
# @description: Computes a SHA224 message digest with gpg and checks digest output.
# @timeout: 180
...
case_id="usage-gpg-print-md-sha224"
tmpdir=$(mktemp -d)
