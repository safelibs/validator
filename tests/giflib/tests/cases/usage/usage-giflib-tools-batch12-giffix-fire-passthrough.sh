...
# @title: giffix passes a clean GIF through unchanged frames
# @description: Runs giffix on a non-interlaced fixture and verifies the output is a valid GIF with the same number of image frames as the input.
# @timeout: 60
