#!/usr/bin/env bash
# @testcase: usage-curl-effective-url-writeout
# @title: curl effective URL writeout
# @description: Exercises curl effective url writeout through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: curl
...
case_id="usage-curl-effective-url-writeout"
tmpdir=$(mktemp -d)
