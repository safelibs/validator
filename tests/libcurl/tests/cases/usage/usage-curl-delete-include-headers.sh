#!/usr/bin/env bash
# @testcase: usage-curl-delete-include-headers
# @title: curl DELETE include headers
# @description: Exercises curl delete include headers through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: curl
...
case_id="usage-curl-delete-include-headers"
tmpdir=$(mktemp -d)
