#!/usr/bin/env bash
# @testcase: usage-curl-query-data-urlencode-batch11
# @title: curl data urlencode query
# @description: Builds an encoded query string with curl --data-urlencode.
# @timeout: 180
...
case_id="usage-curl-query-data-urlencode-batch11"
tmpdir=$(mktemp -d)
