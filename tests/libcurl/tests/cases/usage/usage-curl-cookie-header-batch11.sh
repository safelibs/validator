#!/usr/bin/env bash
# @testcase: usage-curl-cookie-header-batch11
# @title: curl cookie header
# @description: Sends a cookie header with curl to a loopback server.
# @timeout: 180
...
case_id="usage-curl-cookie-header-batch11"
tmpdir=$(mktemp -d)
