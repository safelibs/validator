#!/usr/bin/env bash
# @testcase: usage-curl-redirect-count-writeout
# @title: curl redirect count writeout
# @description: Exercises curl redirect count writeout through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: curl
...
case_id="usage-curl-redirect-count-writeout"
tmpdir=$(mktemp -d)
