#!/usr/bin/env bash
# @testcase: usage-curl-data-urlencode-plus
# @title: curl data urlencode plus
# @description: Exercises curl data urlencode plus through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: curl
...
case_id="usage-curl-data-urlencode-plus"
tmpdir=$(mktemp -d)
