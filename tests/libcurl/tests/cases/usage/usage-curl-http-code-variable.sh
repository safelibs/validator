#!/usr/bin/env bash
# @testcase: usage-curl-http-code-variable
# @title: curl write-out content type
# @description: Uses curl write-out variables to report HTTP status and content type.
# @timeout: 180
# @tags: usage, http
# @client: curl
...
case_id="usage-curl-http-code-variable"
tmpdir=$(mktemp -d)
