#!/usr/bin/env bash
# @testcase: usage-curl-http1-1-request
# @title: curl HTTP 1.1 request
# @description: Exercises curl http 1.1 request through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: curl
...
case_id="usage-curl-http1-1-request"
tmpdir=$(mktemp -d)
