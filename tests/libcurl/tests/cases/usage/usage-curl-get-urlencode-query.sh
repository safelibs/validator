#!/usr/bin/env bash
# @testcase: usage-curl-get-urlencode-query
# @title: curl GET URL encoded query
# @description: Exercises curl get url encoded query through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: curl
...
case_id="usage-curl-get-urlencode-query"
tmpdir=$(mktemp -d)
