#!/usr/bin/env bash
# @testcase: usage-curl-urlencoded-post
# @title: curl URL-encoded post
# @description: Posts URL-encoded form data with curl and verifies the encoded request body.
# @timeout: 180
# @tags: usage, http, cli
# @client: curl
...
case_id="usage-curl-urlencoded-post"
tmpdir=$(mktemp -d)
