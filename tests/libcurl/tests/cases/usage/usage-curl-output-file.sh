#!/usr/bin/env bash
# @testcase: usage-curl-output-file
# @title: curl writes output file
# @description: Downloads a local HTTP fixture into a chosen output file.
# @timeout: 120
# @tags: usage, http
# @client: curl
...
case_id="usage-curl-output-file"
tmpdir=$(mktemp -d)
