#!/usr/bin/env bash
# @testcase: usage-curl-create-dirs-output
# @title: curl create directories output
# @description: Exercises curl create directories output through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: curl
...
case_id="usage-curl-create-dirs-output"
tmpdir=$(mktemp -d)
