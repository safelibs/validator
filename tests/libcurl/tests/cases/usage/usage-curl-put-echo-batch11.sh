#!/usr/bin/env bash
# @testcase: usage-curl-put-echo-batch11
# @title: curl PUT echo
# @description: Sends a PUT body with curl to a loopback server and checks the echoed body.
# @timeout: 180
...
case_id="usage-curl-put-echo-batch11"
tmpdir=$(mktemp -d)
