#!/usr/bin/env bash
# @testcase: usage-curl-post-empty-body
# @title: curl POST empty body
# @description: Exercises curl post empty body through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: curl
...
case_id="usage-curl-post-empty-body"
tmpdir=$(mktemp -d)
