#!/usr/bin/env bash
# @testcase: usage-curl-etag-header-output-batch11
# @title: curl ETag header output
# @description: Captures response headers with curl and checks an ETag value.
# @timeout: 180
...
case_id="usage-curl-etag-header-output-batch11"
tmpdir=$(mktemp -d)
