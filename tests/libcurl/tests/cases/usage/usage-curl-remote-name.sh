#!/usr/bin/env bash
# @testcase: usage-curl-remote-name
# @title: curl remote name output
# @description: Downloads a local file with curl remote-name handling and verifies the saved file.
# @timeout: 180
# @tags: usage, http
# @client: curl
...
case_id="usage-curl-remote-name"
tmpdir=$(mktemp -d)
