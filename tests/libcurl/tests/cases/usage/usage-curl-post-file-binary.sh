#!/usr/bin/env bash
# @testcase: usage-curl-post-file-binary
# @title: curl posts binary file
# @description: Uploads file bytes with curl data-binary mode and verifies the echoed payload.
# @timeout: 180
# @tags: usage, http, cli
# @client: curl
...
case_id="usage-curl-post-file-binary"
tmpdir=$(mktemp -d)
