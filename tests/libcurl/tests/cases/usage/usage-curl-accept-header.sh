#!/usr/bin/env bash
# @testcase: usage-curl-accept-header
# @title: curl Accept header echo
# @description: Exercises curl accept header echo through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: curl
...
case_id="usage-curl-accept-header"
tmpdir=$(mktemp -d)
