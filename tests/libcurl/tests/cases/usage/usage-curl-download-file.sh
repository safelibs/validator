#!/usr/bin/env bash
# @testcase: usage-curl-download-file
# @title: curl downloads file
# @description: Downloads a local file to disk with curl and verifies the saved payload contents.
# @timeout: 180
# @tags: usage, http, cli
# @client: curl
...
case_id="usage-curl-download-file"
tmpdir=$(mktemp -d)
