#!/usr/bin/env bash
# @testcase: usage-curl-writeout-num-headers
# @title: curl writeout num headers
# @description: Captures the num_headers writeout variable from curl and verifies a positive header count is reported.
# @timeout: 180
...
case_id="usage-curl-writeout-num-headers"
tmpdir=$(mktemp -d)
