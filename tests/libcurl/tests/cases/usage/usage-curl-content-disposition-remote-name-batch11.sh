#!/usr/bin/env bash
# @testcase: usage-curl-content-disposition-remote-name-batch11
# @title: curl content disposition remote name
# @description: Downloads a named attachment with curl -OJ.
# @timeout: 180
...
case_id="usage-curl-content-disposition-remote-name-batch11"
tmpdir=$(mktemp -d)
