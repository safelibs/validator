#!/usr/bin/env bash
# @testcase: usage-curl-query-params
# @title: curl sends query parameters
# @description: Fetches a local HTTP endpoint and verifies curl transmits query parameters.
# @timeout: 180
# @tags: usage, http
# @client: curl
...
case_id="usage-curl-query-params"
tmpdir=$(mktemp -d)
