...
unsafe extern "C" fn write_header(
    ...
    let mut targaheader: [::core::ffi::c_char; 18] = [0; 18];
    memset(
        &raw mut targaheader as *mut ::core::ffi::c_char as *mut ::core::ffi::c_void,
        0 as ::core::ffi::c_int,
        ::core::mem::size_of::<[::core::ffi::c_char; 18]>() as size_t,
    );
    if num_colors > 0 as ::core::ffi::c_int {
        targaheader[1 as ::core::ffi::c_int as usize] = 1 as ::core::ffi::c_char;
        targaheader[5 as ::core::ffi::c_int as usize] =
            (num_colors & 0xff as ::core::ffi::c_int) as ::core::ffi::c_char;
        targaheader[6 as ::core::ffi::c_int as usize] =
            (num_colors >> 8 as ::core::ffi::c_int) as ::core::ffi::c_char;
        targaheader[7 as ::core::ffi::c_int as usize] = 24 as ::core::ffi::c_char;
    }
    targaheader[12 as ::core::ffi::c_int as usize] =
        ((*cinfo).output_width & 0xff as JDIMENSION) as ::core::ffi::c_char;
    targaheader[13 as ::core::ffi::c_int as usize] =
        ((*cinfo).output_width >> 8 as ::core::ffi::c_int) as ::core::ffi::c_char;
    targaheader[14 as ::core::ffi::c_int as usize] =
        ((*cinfo).output_height & 0xff as JDIMENSION) as ::core::ffi::c_char;
    targaheader[15 as ::core::ffi::c_int as usize] =
        ((*cinfo).output_height >> 8 as ::core::ffi::c_int) as ::core::ffi::c_char;
    targaheader[17 as ::core::ffi::c_int as usize] = 0x20 as ::core::ffi::c_char;
    if (*cinfo).out_color_space as ::core::ffi::c_uint
        == JCS_GRAYSCALE as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        targaheader[2 as ::core::ffi::c_int as usize] = 3 as ::core::ffi::c_char;
        targaheader[16 as ::core::ffi::c_int as usize] = 8 as ::core::ffi::c_char;
    } else if num_colors > 0 as ::core::ffi::c_int {
        targaheader[2 as ::core::ffi::c_int as usize] = 1 as ::core::ffi::c_char;
        targaheader[16 as ::core::ffi::c_int as usize] = 8 as ::core::ffi::c_char;
    } else {
        targaheader[2 as ::core::ffi::c_int as usize] = 2 as ::core::ffi::c_char;
        targaheader[16 as ::core::ffi::c_int as usize] = 24 as ::core::ffi::c_char;
    }
    if fwrite(
        &raw mut targaheader as *mut ::core::ffi::c_char as *const ::core::ffi::c_void,
        1 as size_t,
        18 as size_t,
        (*dinfo).output_file,
    ) as size_t
...
unsafe extern "C" fn put_pixel_rows(
    ...
    while col > 0 as JDIMENSION {
        *outptr.offset(0 as ::core::ffi::c_int as isize) =
            *inptr.offset(2 as ::core::ffi::c_int as isize) as ::core::ffi::c_char;
        *outptr.offset(1 as ::core::ffi::c_int as isize) =
            *inptr.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_char;
        *outptr.offset(2 as ::core::ffi::c_int as isize) =
            *inptr.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_char;
        inptr = inptr.offset(3 as ::core::ffi::c_int as isize);
...
unsafe extern "C" fn put_demapped_gray(
    ...
    while col > 0 as JDIMENSION {
        ...
        *fresh1 = *color_map0.offset(*fresh0 as isize) as ::core::ffi::c_char;
        col = col.wrapping_sub(1);
    }
    fwrite(
        (*dest).iobuffer as *const ::core::ffi::c_void,
...
unsafe extern "C" fn start_output_tga(mut cinfo: j_decompress_ptr, mut dinfo: djpeg_dest_ptr) {
    let mut dest: tga_dest_ptr = dinfo as tga_dest_ptr;
    let mut num_colors: ::core::ffi::c_int = 0;
    let mut i: ::core::ffi::c_int = 0;
    let mut outfile: *mut FILE = ::core::ptr::null_mut::<FILE>();
    if (*cinfo).out_color_space as ::core::ffi::c_uint
        == JCS_GRAYSCALE as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        write_header(cinfo, dinfo, 0 as ::core::ffi::c_int);
        ...
        == JCS_RGB as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        if (*cinfo).quantize_colors != 0 {
            ...
            if num_colors > 256 as ::core::ffi::c_int {
                ...
                (*(*cinfo).err).msg_parm.i[0 as ::core::ffi::c_int as usize] = num_colors;
                Some(
                    (*(*cinfo).err)
                        .error_exit
                        .expect("non-null function pointer"),
        ...
        (*(*cinfo).err).msg_code = JERR_TGA_COLORSPACE as ::core::ffi::c_int;
        Some(
            (*(*cinfo).err)
                .error_exit
                .expect("non-null function pointer"),
...
pub unsafe extern "C" fn jinit_write_targa(mut cinfo: j_decompress_ptr) -> djpeg_dest_ptr {
    let mut dest: tga_dest_ptr = ::core::ptr::null_mut::<tga_dest_struct>();
    dest = Some(
        (*(*cinfo).mem)
            .alloc_small
            .expect("non-null function pointer"),
    ...
    .expect("non-null function pointer")(
        ...
        JPOOL_IMAGE,
        ::core::mem::size_of::<tga_dest_struct>() as size_t,
    ) as tga_dest_ptr;
    (*dest).pub_0.start_output =
        Some(start_output_tga as unsafe extern "C" fn(j_decompress_ptr, djpeg_dest_ptr) -> ())
            as Option<unsafe extern "C" fn(j_decompress_ptr, djpeg_dest_ptr) -> ()>;
    (*dest).pub_0.finish_output =
        Some(finish_output_tga as unsafe extern "C" fn(j_decompress_ptr, djpeg_dest_ptr) -> ())
            as Option<unsafe extern "C" fn(j_decompress_ptr, djpeg_dest_ptr) -> ()>;
    (*dest).pub_0.calc_buffer_dimensions = Some(
        calc_buffer_dimensions_tga as unsafe extern "C" fn(j_decompress_ptr, djpeg_dest_ptr) -> (),
    )
        as Option<unsafe extern "C" fn(j_decompress_ptr, djpeg_dest_ptr) -> ()>;
