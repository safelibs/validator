...
unsafe extern "C" fn add_map_entry(
    ...
    let mut colormap0: JSAMPROW = *(*cinfo).colormap.offset(0 as ::core::ffi::c_int as isize);
    let mut colormap1: JSAMPROW = *(*cinfo).colormap.offset(1 as ::core::ffi::c_int as isize);
    let mut colormap2: JSAMPROW = *(*cinfo).colormap.offset(2 as ::core::ffi::c_int as isize);
    let mut ncolors: ::core::ffi::c_int = (*cinfo).actual_number_of_colors;
    let mut index: ::core::ffi::c_int = 0;
    index = 0 as ::core::ffi::c_int;
    while index < ncolors {
        if *colormap0.offset(index as isize) as ::core::ffi::c_int == R
            && *colormap1.offset(index as isize) as ::core::ffi::c_int == G
            && *colormap2.offset(index as isize) as ::core::ffi::c_int == B
        {
            return;
        }
        index += 1;
    }
    if ncolors >= MAXJSAMPLE + 1 as ::core::ffi::c_int {
        (*(*cinfo).err).msg_code = JERR_QUANT_MANY_COLORS as ::core::ffi::c_int;
        (*(*cinfo).err).msg_parm.i[0 as ::core::ffi::c_int as usize] =
            255 as ::core::ffi::c_int + 1 as ::core::ffi::c_int;
        Some(
            (*(*cinfo).err)
                .error_exit
...
unsafe extern "C" fn read_gif_map(mut cinfo: j_decompress_ptr, mut infile: *mut FILE) {
    let mut header: [::core::ffi::c_int; 13] = [0; 13];
    ...
    while i < 13 as ::core::ffi::c_int {
        ...
        if header[i as usize] == EOF {
            (*(*cinfo).err).msg_code = JERR_BAD_CMAP_FILE as ::core::ffi::c_int;
            Some(
                (*(*cinfo).err)
                    .error_exit
                    .expect("non-null function pointer"),
    ...
    if header[1 as ::core::ffi::c_int as usize] != 'I' as i32
        || header[2 as ::core::ffi::c_int as usize] != 'F' as i32
    {
        (*(*cinfo).err).msg_code = JERR_BAD_CMAP_FILE as ::core::ffi::c_int;
        Some(
            (*(*cinfo).err)
    ...
    if header[10 as ::core::ffi::c_int as usize] & 0x80 as ::core::ffi::c_int
        == 0 as ::core::ffi::c_int
    {
        (*(*cinfo).err).msg_code = JERR_BAD_CMAP_FILE as ::core::ffi::c_int;
        Some(
    ...
    colormaplen = (2 as ::core::ffi::c_int)
        << (header[10 as ::core::ffi::c_int as usize] & 0x7 as ::core::ffi::c_int);
    ...
    while i < colormaplen {
        ...
        add_map_entry(
            cinfo,
            R << BITS_IN_JSAMPLE - 8 as ::core::ffi::c_int,
            G << BITS_IN_JSAMPLE - 8 as ::core::ffi::c_int,
            B << BITS_IN_JSAMPLE - 8 as ::core::ffi::c_int,
        );
        i += 1;
    }
}
    ...
    match c {
        51 => {
            ...
            while row < h {
                ...
                while col < w {
                    R = read_pbm_integer(cinfo, infile) as ::core::ffi::c_int;
                    G = read_pbm_integer(cinfo, infile) as ::core::ffi::c_int;
                    B = read_pbm_integer(cinfo, infile) as ::core::ffi::c_int;
...
pub unsafe extern "C" fn read_color_map(mut cinfo: j_decompress_ptr, mut infile: *mut FILE) {
    ...
    .expect("non-null function pointer")(
        cinfo as j_common_ptr,
        JPOOL_IMAGE,
        (MAXJSAMPLE + 1 as ::core::ffi::c_int) as JDIMENSION,
        3 as ::core::ffi::c_int as JDIMENSION,
    );
    (*cinfo).actual_number_of_colors = 0 as ::core::ffi::c_int;
    match getc(infile) {
        71 => {
