...
pub type IFAST_MULT_TYPE = ::core::ffi::c_short;
...
pub unsafe extern "C" fn jpeg_idct_ifast(
    ...
    let mut quantptr: *mut IFAST_MULT_TYPE = ::core::ptr::null_mut::<IFAST_MULT_TYPE>();
    ...
    while ctr > 0 as ::core::ffi::c_int {
        if *inptr.offset((DCTSIZE * 1 as ::core::ffi::c_int) as isize) as ::core::ffi::c_int
            ...
            && *inptr.offset((DCTSIZE * 7 as ::core::ffi::c_int) as isize) as ::core::ffi::c_int
                == 0 as ::core::ffi::c_int
        {
            let mut dcval: ::core::ffi::c_int = *inptr
            ...
            *wsptr.offset((DCTSIZE * 7 as ::core::ffi::c_int) as isize) = dcval;
            ...
            tmp1 = (*inptr.offset((8 as ::core::ffi::c_int * 2 as ::core::ffi::c_int) as isize)
                as ::core::ffi::c_int
            ...
            tmp2 = (*inptr.offset((8 as ::core::ffi::c_int * 4 as ::core::ffi::c_int) as isize)
                ...
                * *quantptr.offset((8 as ::core::ffi::c_int * 4 as ::core::ffi::c_int) as isize)
                    as ::core::ffi::c_int) as DCTELEM;
            tmp3 = (*inptr.offset((8 as ::core::ffi::c_int * 6 as ::core::ffi::c_int) as isize)
                as ::core::ffi::c_int
                * *quantptr.offset((8 as ::core::ffi::c_int * 6 as ::core::ffi::c_int) as isize)
                    as ::core::ffi::c_int) as DCTELEM;
            tmp10 = (tmp0 as ::core::ffi::c_int + tmp2 as ::core::ffi::c_int) as DCTELEM;
            tmp11 = (tmp0 as ::core::ffi::c_int - tmp2 as ::core::ffi::c_int) as DCTELEM;
            tmp13 = (tmp1 as ::core::ffi::c_int + tmp3 as ::core::ffi::c_int) as DCTELEM;
            tmp12 = (((tmp1 as ::core::ffi::c_int - tmp3 as ::core::ffi::c_int) as JLONG
                * 362 as ::core::ffi::c_int as JLONG
                >> 8 as ::core::ffi::c_int) as DCTELEM as ::core::ffi::c_int
                - tmp13 as ::core::ffi::c_int) as DCTELEM;
            tmp0 = (tmp10 as ::core::ffi::c_int + tmp13 as ::core::ffi::c_int) as DCTELEM;
            tmp3 = (tmp10 as ::core::ffi::c_int - tmp13 as ::core::ffi::c_int) as DCTELEM;
            tmp1 = (tmp11 as ::core::ffi::c_int + tmp12 as ::core::ffi::c_int) as DCTELEM;
            tmp2 = (tmp11 as ::core::ffi::c_int - tmp12 as ::core::ffi::c_int) as DCTELEM;
            tmp4 = (*inptr.offset((8 as ::core::ffi::c_int * 1 as ::core::ffi::c_int) as isize)
                as ::core::ffi::c_int
                * *quantptr.offset((8 as ::core::ffi::c_int * 1 as ::core::ffi::c_int) as isize)
                    as ::core::ffi::c_int) as DCTELEM;
            tmp5 = (*inptr.offset((8 as ::core::ffi::c_int * 3 as ::core::ffi::c_int) as isize)
                as ::core::ffi::c_int
                * *quantptr.offset((8 as ::core::ffi::c_int * 3 as ::core::ffi::c_int) as isize)
                    as ::core::ffi::c_int) as DCTELEM;
            tmp6 = (*inptr.offset((8 as ::core::ffi::c_int * 5 as ::core::ffi::c_int) as isize)
                as ::core::ffi::c_int
                * *quantptr.offset((8 as ::core::ffi::c_int * 5 as ::core::ffi::c_int) as isize)
                    as ::core::ffi::c_int) as DCTELEM;
            tmp7 = (*inptr.offset((8 as ::core::ffi::c_int * 7 as ::core::ffi::c_int) as isize)
                as ::core::ffi::c_int
                * *quantptr.offset((8 as ::core::ffi::c_int * 7 as ::core::ffi::c_int) as isize)
                    as ::core::ffi::c_int) as DCTELEM;
            z13 = (tmp6 as ::core::ffi::c_int + tmp5 as ::core::ffi::c_int) as DCTELEM;
            z10 = (tmp6 as ::core::ffi::c_int - tmp5 as ::core::ffi::c_int) as DCTELEM;
            z11 = (tmp4 as ::core::ffi::c_int + tmp7 as ::core::ffi::c_int) as DCTELEM;
            z12 = (tmp4 as ::core::ffi::c_int - tmp7 as ::core::ffi::c_int) as DCTELEM;
            tmp7 = (z11 as ::core::ffi::c_int + z13 as ::core::ffi::c_int) as DCTELEM;
            tmp11 = ((z11 as ::core::ffi::c_int - z13 as ::core::ffi::c_int) as JLONG
                * 362 as ::core::ffi::c_int as JLONG
                >> 8 as ::core::ffi::c_int) as DCTELEM;
            z5 = ((z10 as ::core::ffi::c_int + z12 as ::core::ffi::c_int) as JLONG
                * 473 as ::core::ffi::c_int as JLONG
                >> 8 as ::core::ffi::c_int) as DCTELEM;
            tmp10 = ((z12 as JLONG * 277 as ::core::ffi::c_int as JLONG >> 8 as ::core::ffi::c_int)
                as DCTELEM as ::core::ffi::c_int
                - z5 as ::core::ffi::c_int) as DCTELEM;
            tmp12 = ((z10 as JLONG * -(669 as ::core::ffi::c_int as JLONG)
                >> 8 as ::core::ffi::c_int) as DCTELEM as ::core::ffi::c_int
                + z5 as ::core::ffi::c_int) as DCTELEM;
            tmp6 = (tmp12 as ::core::ffi::c_int - tmp7 as ::core::ffi::c_int) as DCTELEM;
            tmp5 = (tmp11 as ::core::ffi::c_int - tmp6 as ::core::ffi::c_int) as DCTELEM;
            tmp4 = (tmp10 as ::core::ffi::c_int + tmp5 as ::core::ffi::c_int) as DCTELEM;
            *wsptr.offset((DCTSIZE * 0 as ::core::ffi::c_int) as isize) =
                tmp0 as ::core::ffi::c_int + tmp7 as ::core::ffi::c_int;
            *wsptr.offset((DCTSIZE * 7 as ::core::ffi::c_int) as isize) =
                tmp0 as ::core::ffi::c_int - tmp7 as ::core::ffi::c_int;
            *wsptr.offset((DCTSIZE * 1 as ::core::ffi::c_int) as isize) =
                tmp1 as ::core::ffi::c_int + tmp6 as ::core::ffi::c_int;
            *wsptr.offset((DCTSIZE * 6 as ::core::ffi::c_int) as isize) =
                tmp1 as ::core::ffi::c_int - tmp6 as ::core::ffi::c_int;
            *wsptr.offset((DCTSIZE * 2 as ::core::ffi::c_int) as isize) =
                tmp2 as ::core::ffi::c_int + tmp5 as ::core::ffi::c_int;
            *wsptr.offset((DCTSIZE * 5 as ::core::ffi::c_int) as isize) =
                tmp2 as ::core::ffi::c_int - tmp5 as ::core::ffi::c_int;
            *wsptr.offset((DCTSIZE * 4 as ::core::ffi::c_int) as isize) =
                tmp3 as ::core::ffi::c_int + tmp4 as ::core::ffi::c_int;
            *wsptr.offset((DCTSIZE * 3 as ::core::ffi::c_int) as isize) =
                tmp3 as ::core::ffi::c_int - tmp4 as ::core::ffi::c_int;
            inptr = inptr.offset(1);
            quantptr = quantptr.offset(1);
            wsptr = wsptr.offset(1);
    ...
    while ctr < DCTSIZE {
            ...
            && *wsptr.offset(7 as ::core::ffi::c_int as isize) == 0 as ::core::ffi::c_int
        {
            let mut dcval_0: JSAMPLE = *range_limit.offset(
                (*wsptr.offset(0 as ::core::ffi::c_int as isize)
            ...
            *outptr.offset(7 as ::core::ffi::c_int as isize) = dcval_0;
            ...
            tmp10 = (*wsptr.offset(0 as ::core::ffi::c_int as isize) as DCTELEM
                as ::core::ffi::c_int
                + *wsptr.offset(4 as ::core::ffi::c_int as isize) as DCTELEM as ::core::ffi::c_int)
                as DCTELEM;
            tmp11 = (*wsptr.offset(0 as ::core::ffi::c_int as isize) as DCTELEM
                as ::core::ffi::c_int
                - *wsptr.offset(4 as ::core::ffi::c_int as isize) as DCTELEM as ::core::ffi::c_int)
                as DCTELEM;
            tmp13 = (*wsptr.offset(2 as ::core::ffi::c_int as isize) as DCTELEM
                as ::core::ffi::c_int
                + *wsptr.offset(6 as ::core::ffi::c_int as isize) as DCTELEM as ::core::ffi::c_int)
                as DCTELEM;
            tmp12 = (((*wsptr.offset(2 as ::core::ffi::c_int as isize) as DCTELEM
                as ::core::ffi::c_int
                - *wsptr.offset(6 as ::core::ffi::c_int as isize) as DCTELEM as ::core::ffi::c_int)
                as JLONG
                * 362 as ::core::ffi::c_int as JLONG
            ...
            tmp1 = (tmp11 as ::core::ffi::c_int + tmp12 as ::core::ffi::c_int) as DCTELEM;
            tmp2 = (tmp11 as ::core::ffi::c_int - tmp12 as ::core::ffi::c_int) as DCTELEM;
            z13 = (*wsptr.offset(5 as ::core::ffi::c_int as isize) as DCTELEM as ::core::ffi::c_int
                + *wsptr.offset(3 as ::core::ffi::c_int as isize) as DCTELEM as ::core::ffi::c_int)
                as DCTELEM;
            z10 = (*wsptr.offset(5 as ::core::ffi::c_int as isize) as DCTELEM as ::core::ffi::c_int
                - *wsptr.offset(3 as ::core::ffi::c_int as isize) as DCTELEM as ::core::ffi::c_int)
                as DCTELEM;
            z11 = (*wsptr.offset(1 as ::core::ffi::c_int as isize) as DCTELEM as ::core::ffi::c_int
                + *wsptr.offset(7 as ::core::ffi::c_int as isize) as DCTELEM as ::core::ffi::c_int)
                as DCTELEM;
            z12 = (*wsptr.offset(1 as ::core::ffi::c_int as isize) as DCTELEM as ::core::ffi::c_int
                - *wsptr.offset(7 as ::core::ffi::c_int as isize) as DCTELEM as ::core::ffi::c_int)
                as DCTELEM;
            tmp7 = (z11 as ::core::ffi::c_int + z13 as ::core::ffi::c_int) as DCTELEM;
            tmp11 = ((z11 as ::core::ffi::c_int - z13 as ::core::ffi::c_int) as JLONG
