...
extern "C" {
    ...
    fn jinit_d_post_controller(cinfo: j_decompress_ptr, need_full_buffer: boolean);
...
unsafe extern "C" fn use_merged_upsample(mut cinfo: j_decompress_ptr) -> boolean {
    ...
    if (*(*cinfo).comp_info.offset(0 as ::core::ffi::c_int as isize)).h_samp_factor
        != 2 as ::core::ffi::c_int
    ...
    if (*(*cinfo).comp_info.offset(0 as ::core::ffi::c_int as isize)).DCT_h_scaled_size
        != (*cinfo).min_DCT_h_scaled_size
        || (*(*cinfo).comp_info.offset(1 as ::core::ffi::c_int as isize)).DCT_h_scaled_size
            != (*cinfo).min_DCT_h_scaled_size
        || (*(*cinfo).comp_info.offset(2 as ::core::ffi::c_int as isize)).DCT_h_scaled_size
            != (*cinfo).min_DCT_h_scaled_size
    {
        return FALSE;
    }
...
pub unsafe extern "C" fn jpeg_core_output_dimensions(mut cinfo: j_decompress_ptr) {
    ...
    if (*cinfo)
        .scale_num
        .wrapping_mul(DCTSIZE as ::core::ffi::c_uint)
        <= (*cinfo).scale_denom
    {
        ...
        (*cinfo).min_DCT_v_scaled_size = 1 as ::core::ffi::c_int;
    } else if (*cinfo)
        .scale_num
        .wrapping_mul(DCTSIZE as ::core::ffi::c_uint)
        <= (*cinfo).scale_denom.wrapping_mul(2 as ::core::ffi::c_uint)
    {
        (*cinfo).output_width = jdiv_round_up(
            (*cinfo).image_width as ::core::ffi::c_long * 2 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).output_height = jdiv_round_up(
            (*cinfo).image_height as ::core::ffi::c_long * 2 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).min_DCT_h_scaled_size = 2 as ::core::ffi::c_int;
        (*cinfo).min_DCT_v_scaled_size = 2 as ::core::ffi::c_int;
    } else if (*cinfo)
        .scale_num
        .wrapping_mul(DCTSIZE as ::core::ffi::c_uint)
        <= (*cinfo).scale_denom.wrapping_mul(3 as ::core::ffi::c_uint)
    {
        (*cinfo).output_width = jdiv_round_up(
            (*cinfo).image_width as ::core::ffi::c_long * 3 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).output_height = jdiv_round_up(
            (*cinfo).image_height as ::core::ffi::c_long * 3 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).min_DCT_h_scaled_size = 3 as ::core::ffi::c_int;
        (*cinfo).min_DCT_v_scaled_size = 3 as ::core::ffi::c_int;
    } else if (*cinfo)
        .scale_num
        .wrapping_mul(DCTSIZE as ::core::ffi::c_uint)
        <= (*cinfo).scale_denom.wrapping_mul(4 as ::core::ffi::c_uint)
    {
        (*cinfo).output_width = jdiv_round_up(
            (*cinfo).image_width as ::core::ffi::c_long * 4 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).output_height = jdiv_round_up(
            (*cinfo).image_height as ::core::ffi::c_long * 4 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).min_DCT_h_scaled_size = 4 as ::core::ffi::c_int;
        (*cinfo).min_DCT_v_scaled_size = 4 as ::core::ffi::c_int;
    } else if (*cinfo)
        .scale_num
        .wrapping_mul(DCTSIZE as ::core::ffi::c_uint)
        <= (*cinfo).scale_denom.wrapping_mul(5 as ::core::ffi::c_uint)
    {
        (*cinfo).output_width = jdiv_round_up(
            (*cinfo).image_width as ::core::ffi::c_long * 5 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).output_height = jdiv_round_up(
            (*cinfo).image_height as ::core::ffi::c_long * 5 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).min_DCT_h_scaled_size = 5 as ::core::ffi::c_int;
        (*cinfo).min_DCT_v_scaled_size = 5 as ::core::ffi::c_int;
    } else if (*cinfo)
        .scale_num
        .wrapping_mul(DCTSIZE as ::core::ffi::c_uint)
        <= (*cinfo).scale_denom.wrapping_mul(6 as ::core::ffi::c_uint)
    {
        (*cinfo).output_width = jdiv_round_up(
            (*cinfo).image_width as ::core::ffi::c_long * 6 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).output_height = jdiv_round_up(
            (*cinfo).image_height as ::core::ffi::c_long * 6 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).min_DCT_h_scaled_size = 6 as ::core::ffi::c_int;
        (*cinfo).min_DCT_v_scaled_size = 6 as ::core::ffi::c_int;
    } else if (*cinfo)
        .scale_num
        .wrapping_mul(DCTSIZE as ::core::ffi::c_uint)
        <= (*cinfo).scale_denom.wrapping_mul(7 as ::core::ffi::c_uint)
    {
        (*cinfo).output_width = jdiv_round_up(
            (*cinfo).image_width as ::core::ffi::c_long * 7 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).output_height = jdiv_round_up(
            (*cinfo).image_height as ::core::ffi::c_long * 7 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).min_DCT_h_scaled_size = 7 as ::core::ffi::c_int;
        (*cinfo).min_DCT_v_scaled_size = 7 as ::core::ffi::c_int;
    } else if (*cinfo)
        .scale_num
        .wrapping_mul(DCTSIZE as ::core::ffi::c_uint)
        <= (*cinfo).scale_denom.wrapping_mul(8 as ::core::ffi::c_uint)
    {
        (*cinfo).output_width = jdiv_round_up(
            (*cinfo).image_width as ::core::ffi::c_long * 8 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).output_height = jdiv_round_up(
            (*cinfo).image_height as ::core::ffi::c_long * 8 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).min_DCT_h_scaled_size = 8 as ::core::ffi::c_int;
        (*cinfo).min_DCT_v_scaled_size = 8 as ::core::ffi::c_int;
    } else if (*cinfo)
        .scale_num
        .wrapping_mul(DCTSIZE as ::core::ffi::c_uint)
        <= (*cinfo).scale_denom.wrapping_mul(9 as ::core::ffi::c_uint)
    {
        (*cinfo).output_width = jdiv_round_up(
            (*cinfo).image_width as ::core::ffi::c_long * 9 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).output_height = jdiv_round_up(
            (*cinfo).image_height as ::core::ffi::c_long * 9 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).min_DCT_h_scaled_size = 9 as ::core::ffi::c_int;
        (*cinfo).min_DCT_v_scaled_size = 9 as ::core::ffi::c_int;
    } else if (*cinfo)
        .scale_num
        .wrapping_mul(DCTSIZE as ::core::ffi::c_uint)
        <= (*cinfo).scale_denom.wrapping_mul(10 as ::core::ffi::c_uint)
    {
        (*cinfo).output_width = jdiv_round_up(
            (*cinfo).image_width as ::core::ffi::c_long * 10 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).output_height = jdiv_round_up(
            (*cinfo).image_height as ::core::ffi::c_long * 10 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).min_DCT_h_scaled_size = 10 as ::core::ffi::c_int;
        (*cinfo).min_DCT_v_scaled_size = 10 as ::core::ffi::c_int;
    } else if (*cinfo)
        .scale_num
        .wrapping_mul(DCTSIZE as ::core::ffi::c_uint)
        <= (*cinfo).scale_denom.wrapping_mul(11 as ::core::ffi::c_uint)
    {
        (*cinfo).output_width = jdiv_round_up(
            (*cinfo).image_width as ::core::ffi::c_long * 11 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).output_height = jdiv_round_up(
            (*cinfo).image_height as ::core::ffi::c_long * 11 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).min_DCT_h_scaled_size = 11 as ::core::ffi::c_int;
        (*cinfo).min_DCT_v_scaled_size = 11 as ::core::ffi::c_int;
    } else if (*cinfo)
        .scale_num
        .wrapping_mul(DCTSIZE as ::core::ffi::c_uint)
        <= (*cinfo).scale_denom.wrapping_mul(12 as ::core::ffi::c_uint)
    {
        (*cinfo).output_width = jdiv_round_up(
            (*cinfo).image_width as ::core::ffi::c_long * 12 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).output_height = jdiv_round_up(
            (*cinfo).image_height as ::core::ffi::c_long * 12 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).min_DCT_h_scaled_size = 12 as ::core::ffi::c_int;
        (*cinfo).min_DCT_v_scaled_size = 12 as ::core::ffi::c_int;
    } else if (*cinfo)
        .scale_num
        .wrapping_mul(DCTSIZE as ::core::ffi::c_uint)
        <= (*cinfo).scale_denom.wrapping_mul(13 as ::core::ffi::c_uint)
    {
        (*cinfo).output_width = jdiv_round_up(
            (*cinfo).image_width as ::core::ffi::c_long * 13 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).output_height = jdiv_round_up(
            (*cinfo).image_height as ::core::ffi::c_long * 13 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).min_DCT_h_scaled_size = 13 as ::core::ffi::c_int;
        (*cinfo).min_DCT_v_scaled_size = 13 as ::core::ffi::c_int;
    } else if (*cinfo)
        .scale_num
        .wrapping_mul(DCTSIZE as ::core::ffi::c_uint)
        <= (*cinfo).scale_denom.wrapping_mul(14 as ::core::ffi::c_uint)
    {
        (*cinfo).output_width = jdiv_round_up(
            (*cinfo).image_width as ::core::ffi::c_long * 14 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).output_height = jdiv_round_up(
            (*cinfo).image_height as ::core::ffi::c_long * 14 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).min_DCT_h_scaled_size = 14 as ::core::ffi::c_int;
        (*cinfo).min_DCT_v_scaled_size = 14 as ::core::ffi::c_int;
    } else if (*cinfo)
        .scale_num
        .wrapping_mul(DCTSIZE as ::core::ffi::c_uint)
        <= (*cinfo).scale_denom.wrapping_mul(15 as ::core::ffi::c_uint)
    {
        (*cinfo).output_width = jdiv_round_up(
            (*cinfo).image_width as ::core::ffi::c_long * 15 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).output_height = jdiv_round_up(
            (*cinfo).image_height as ::core::ffi::c_long * 15 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).min_DCT_h_scaled_size = 15 as ::core::ffi::c_int;
        (*cinfo).min_DCT_v_scaled_size = 15 as ::core::ffi::c_int;
    } else {
        (*cinfo).output_width = jdiv_round_up(
            (*cinfo).image_width as ::core::ffi::c_long * 16 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).output_height = jdiv_round_up(
            (*cinfo).image_height as ::core::ffi::c_long * 16 as ::core::ffi::c_long,
            DCTSIZE as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*cinfo).min_DCT_h_scaled_size = 16 as ::core::ffi::c_int;
        (*cinfo).min_DCT_v_scaled_size = 16 as ::core::ffi::c_int;
    }
...
pub unsafe extern "C" fn jpeg_calc_output_dimensions(mut cinfo: j_decompress_ptr) {
    ...
    compptr = (*cinfo).comp_info;
    while ci < (*cinfo).num_components {
        let mut ssize: ::core::ffi::c_int = (*cinfo).min_DCT_h_scaled_size;
        while ssize < DCTSIZE
            && (*cinfo).max_h_samp_factor * (*cinfo).min_DCT_h_scaled_size
                % ((*compptr).h_samp_factor * ssize * 2 as ::core::ffi::c_int)
                == 0 as ::core::ffi::c_int
            && (*cinfo).max_v_samp_factor * (*cinfo).min_DCT_h_scaled_size
                % ((*compptr).v_samp_factor * ssize * 2 as ::core::ffi::c_int)
                == 0 as ::core::ffi::c_int
        {
            ssize = ssize * 2 as ::core::ffi::c_int;
        }
        (*compptr).DCT_v_scaled_size = ssize;
    ...
    while ci < (*cinfo).num_components {
        (*compptr).downsampled_width = jdiv_round_up(
            (*cinfo).image_width as ::core::ffi::c_long
                * ((*compptr).h_samp_factor * (*compptr).DCT_h_scaled_size) as ::core::ffi::c_long,
            ((*cinfo).max_h_samp_factor * DCTSIZE) as ::core::ffi::c_long,
        ) as JDIMENSION;
        (*compptr).downsampled_height = jdiv_round_up(
            (*cinfo).image_height as ::core::ffi::c_long
                * ((*compptr).v_samp_factor * (*compptr).DCT_h_scaled_size) as ::core::ffi::c_long,
    ...
    if use_merged_upsample(cinfo) != 0 {
        ...
        (*cinfo).rec_outbuf_height = 1 as ::core::ffi::c_int;
    };
}
unsafe extern "C" fn prepare_range_limit_table(mut cinfo: j_decompress_ptr) {
    let mut table: *mut JSAMPLE = ::core::ptr::null_mut::<JSAMPLE>();
    ...
    .expect("non-null function pointer")(
        ...
        JPOOL_IMAGE,
        ((5 as ::core::ffi::c_int * (MAXJSAMPLE + 1 as ::core::ffi::c_int) + CENTERJSAMPLE)
            as size_t)
            .wrapping_mul(::core::mem::size_of::<JSAMPLE>() as size_t),
    ) as *mut JSAMPLE;
    table = table.offset((MAXJSAMPLE + 1 as ::core::ffi::c_int) as isize);
    (*cinfo).sample_range_limit = table;
    memset(
        table.offset(-((MAXJSAMPLE + 1 as ::core::ffi::c_int) as isize))
    ...
    i = CENTERJSAMPLE;
    while i < 2 as ::core::ffi::c_int * (MAXJSAMPLE + 1 as ::core::ffi::c_int) {
        *table.offset(i as isize) = MAXJSAMPLE as JSAMPLE;
        i += 1;
    }
    memset(
        table.offset((2 as ::core::ffi::c_int * (MAXJSAMPLE + 1 as ::core::ffi::c_int)) as isize)
            as *mut ::core::ffi::c_void,
        0 as ::core::ffi::c_int,
        ((2 as ::core::ffi::c_int * (MAXJSAMPLE + 1 as ::core::ffi::c_int) - CENTERJSAMPLE)
            as size_t)
            .wrapping_mul(::core::mem::size_of::<JSAMPLE>() as size_t),
    );
    memcpy(
        table.offset(
            (4 as ::core::ffi::c_int * (MAXJSAMPLE + 1 as ::core::ffi::c_int) - CENTERJSAMPLE)
                as isize,
        ) as *mut ::core::ffi::c_void,
        (*cinfo).sample_range_limit as *const ::core::ffi::c_void,
        (CENTERJSAMPLE as size_t).wrapping_mul(::core::mem::size_of::<JSAMPLE>() as size_t),
    );
}
unsafe extern "C" fn master_selection(mut cinfo: j_decompress_ptr) {
    ...
    samplesperrow = (*cinfo).output_width as ::core::ffi::c_long
        * (*cinfo).out_color_components as ::core::ffi::c_long;
    ...
    (*master).quantizer_1pass = ::core::ptr::null_mut::<jpeg_color_quantizer>();
    (*master).quantizer_2pass = ::core::ptr::null_mut::<jpeg_color_quantizer>();
    if (*cinfo).quantize_colors == 0 || (*cinfo).buffered_image == 0 {
        (*cinfo).enable_1pass_quant = FALSE as boolean;
        (*cinfo).enable_external_quant = FALSE as boolean;
        (*cinfo).enable_2pass_quant = FALSE as boolean;
    }
    if (*cinfo).quantize_colors != 0 {
        ...
        if (*cinfo).out_color_components != 3 as ::core::ffi::c_int {
            (*cinfo).enable_1pass_quant = TRUE as boolean;
            (*cinfo).enable_external_quant = FALSE as boolean;
            (*cinfo).enable_2pass_quant = FALSE as boolean;
            (*cinfo).colormap = ::core::ptr::null_mut::<JSAMPROW>();
        } else if !(*cinfo).colormap.is_null() {
            (*cinfo).enable_external_quant = TRUE as boolean;
        } else if (*cinfo).two_pass_quantize != 0 {
            (*cinfo).enable_2pass_quant = TRUE as boolean;
        } else {
            (*cinfo).enable_1pass_quant = TRUE as boolean;
        }
        if (*cinfo).enable_1pass_quant != 0 {
            jinit_1pass_quantizer(cinfo);
            (*master).quantizer_1pass = (*cinfo).cquantize as *mut jpeg_color_quantizer;
        }
        if (*cinfo).enable_2pass_quant != 0 || (*cinfo).enable_external_quant != 0 {
            jinit_2pass_quantizer(cinfo);
            (*master).quantizer_2pass = (*cinfo).cquantize as *mut jpeg_color_quantizer;
        }
    }
    if (*cinfo).raw_data_out == 0 {
    ...
    (*(*cinfo).master).first_iMCU_col = 0 as JDIMENSION;
    (*(*cinfo).master).last_iMCU_col = (*cinfo).MCUs_per_row.wrapping_sub(1 as JDIMENSION);
    (*(*cinfo).master).last_good_iMCU_row = 0 as JDIMENSION;
        ...
        && (*(*cinfo).inputctl).has_multiple_scans != 0
    {
        ...
        if (*cinfo).progressive_mode != 0 {
            nscans = 2 as ::core::ffi::c_int + 3 as ::core::ffi::c_int * (*cinfo).num_components;
        } else {
...
unsafe extern "C" fn prepare_for_output_pass(mut cinfo: j_decompress_ptr) {
    ...
    if (*master).pub_0.is_dummy_pass != 0 {
        (*master).pub_0.is_dummy_pass = FALSE as boolean;
        Some(
            (*(*cinfo).cquantize)
                .start_pass
                .expect("non-null function pointer"),
        ...
        if (*cinfo).quantize_colors != 0 && (*cinfo).colormap.is_null() {
            if (*cinfo).two_pass_quantize != 0 && (*cinfo).enable_2pass_quant != 0 {
                (*cinfo).cquantize = (*master).quantizer_2pass as *mut jpeg_color_quantizer;
                (*master).pub_0.is_dummy_pass = TRUE as boolean;
            } else if (*cinfo).enable_1pass_quant != 0 {
                (*cinfo).cquantize = (*master).quantizer_1pass as *mut jpeg_color_quantizer;
            } else {
...
pub unsafe extern "C" fn jinit_master_decompress(mut cinfo: j_decompress_ptr) {
    ...
    (*master).pub_0.prepare_for_output_pass =
        Some(prepare_for_output_pass as unsafe extern "C" fn(j_decompress_ptr) -> ())
            as Option<unsafe extern "C" fn(j_decompress_ptr) -> ()>;
    (*master).pub_0.finish_output_pass =
        Some(finish_output_pass as unsafe extern "C" fn(j_decompress_ptr) -> ())
            as Option<unsafe extern "C" fn(j_decompress_ptr) -> ()>;
    (*master).pub_0.is_dummy_pass = FALSE as boolean;
    (*master).pub_0.jinit_upsampler_no_alloc = FALSE as boolean;
