...
pub type FLOAT_MULT_TYPE = ::core::ffi::c_float;
...
pub unsafe extern "C" fn jpeg_idct_float(
    ...
    let mut z10: ::core::ffi::c_float = 0.;
    let mut z11: ::core::ffi::c_float = 0.;
    let mut z12: ::core::ffi::c_float = 0.;
    let mut z13: ::core::ffi::c_float = 0.;
    let mut inptr: JCOEFPTR = ::core::ptr::null_mut::<JCOEF>();
    let mut quantptr: *mut FLOAT_MULT_TYPE = ::core::ptr::null_mut::<FLOAT_MULT_TYPE>();
    let mut wsptr: *mut ::core::ffi::c_float = ::core::ptr::null_mut::<::core::ffi::c_float>();
    ...
    let mut workspace: [::core::ffi::c_float; 64] = [0.; 64];
    inptr = coef_block;
    quantptr = (*compptr).dct_table as *mut FLOAT_MULT_TYPE;
    wsptr = ::core::ptr::addr_of_mut!(workspace) as *mut ::core::ffi::c_float;
    ctr = DCTSIZE;
                ...
                == 0 as ::core::ffi::c_int
        {
            ...
            *wsptr.offset((DCTSIZE * 7 as ::core::ffi::c_int) as isize) = dcval;
            ...
            tmp0 = (*inptr.offset((8 as ::core::ffi::c_int * 0 as ::core::ffi::c_int) as isize)
                as FLOAT_MULT_TYPE
                * (*quantptr.offset((8 as ::core::ffi::c_int * 0 as ::core::ffi::c_int) as isize)
                    * 0.125f64 as FLOAT_MULT_TYPE)) as ::core::ffi::c_float;
            ...
            tmp11 = tmp0 - tmp2;
            tmp13 = tmp1 + tmp3;
            tmp12 = (tmp1 - tmp3) * 1.414213562f64 as ::core::ffi::c_float - tmp13;
            tmp0 = tmp10 + tmp13;
            tmp3 = tmp10 - tmp13;
            tmp1 = tmp11 + tmp12;
            tmp2 = tmp11 - tmp12;
            ...
            z12 = tmp4 - tmp7;
            tmp7 = z11 + z13;
            tmp11 = (z11 - z13) * 1.414213562f64 as ::core::ffi::c_float;
            z5 = (z10 + z12) * 1.847759065f64 as ::core::ffi::c_float;
            tmp10 = z5 - z12 * 1.082392200f64 as ::core::ffi::c_float;
            tmp12 = z5 - z10 * 2.613125930f64 as ::core::ffi::c_float;
            tmp6 = tmp12 - tmp7;
            tmp5 = tmp11 - tmp6;
            tmp4 = tmp10 - tmp5;
            *wsptr.offset((DCTSIZE * 0 as ::core::ffi::c_int) as isize) = tmp0 + tmp7;
            *wsptr.offset((DCTSIZE * 7 as ::core::ffi::c_int) as isize) = tmp0 - tmp7;
            *wsptr.offset((DCTSIZE * 1 as ::core::ffi::c_int) as isize) = tmp1 + tmp6;
            *wsptr.offset((DCTSIZE * 6 as ::core::ffi::c_int) as isize) = tmp1 - tmp6;
            *wsptr.offset((DCTSIZE * 2 as ::core::ffi::c_int) as isize) = tmp2 + tmp5;
            *wsptr.offset((DCTSIZE * 5 as ::core::ffi::c_int) as isize) = tmp2 - tmp5;
            *wsptr.offset((DCTSIZE * 3 as ::core::ffi::c_int) as isize) = tmp3 + tmp4;
            *wsptr.offset((DCTSIZE * 4 as ::core::ffi::c_int) as isize) = tmp3 - tmp4;
            inptr = inptr.offset(1);
            quantptr = quantptr.offset(1);
            wsptr = wsptr.offset(1);
        }
    ...
    while ctr < DCTSIZE {
        ...
        z5 = *wsptr.offset(0 as ::core::ffi::c_int as isize)
            + (CENTERJSAMPLE as ::core::ffi::c_float + 0.5f64 as ::core::ffi::c_float);
        tmp10 = z5 + *wsptr.offset(4 as ::core::ffi::c_int as isize);
        tmp11 = z5 - *wsptr.offset(4 as ::core::ffi::c_int as isize);
        tmp13 = *wsptr.offset(2 as ::core::ffi::c_int as isize)
            + *wsptr.offset(6 as ::core::ffi::c_int as isize);
        tmp12 = (*wsptr.offset(2 as ::core::ffi::c_int as isize)
            - *wsptr.offset(6 as ::core::ffi::c_int as isize))
            * 1.414213562f64 as ::core::ffi::c_float
            - tmp13;
        tmp0 = tmp10 + tmp13;
        tmp3 = tmp10 - tmp13;
        tmp1 = tmp11 + tmp12;
        tmp2 = tmp11 - tmp12;
        z13 = *wsptr.offset(5 as ::core::ffi::c_int as isize)
            + *wsptr.offset(3 as ::core::ffi::c_int as isize);
        z10 = *wsptr.offset(5 as ::core::ffi::c_int as isize)
            - *wsptr.offset(3 as ::core::ffi::c_int as isize);
        z11 = *wsptr.offset(1 as ::core::ffi::c_int as isize)
            + *wsptr.offset(7 as ::core::ffi::c_int as isize);
        z12 = *wsptr.offset(1 as ::core::ffi::c_int as isize)
            - *wsptr.offset(7 as ::core::ffi::c_int as isize);
        tmp7 = z11 + z13;
        tmp11 = (z11 - z13) * 1.414213562f64 as ::core::ffi::c_float;
        z5 = (z10 + z12) * 1.847759065f64 as ::core::ffi::c_float;
        ...
        *outptr.offset(0 as ::core::ffi::c_int as isize) =
            *range_limit.offset(((tmp0 + tmp7) as ::core::ffi::c_int & RANGE_MASK) as isize);
        *outptr.offset(7 as ::core::ffi::c_int as isize) =
            *range_limit.offset(((tmp0 - tmp7) as ::core::ffi::c_int & RANGE_MASK) as isize);
        *outptr.offset(1 as ::core::ffi::c_int as isize) =
            *range_limit.offset(((tmp1 + tmp6) as ::core::ffi::c_int & RANGE_MASK) as isize);
        *outptr.offset(6 as ::core::ffi::c_int as isize) =
            *range_limit.offset(((tmp1 - tmp6) as ::core::ffi::c_int & RANGE_MASK) as isize);
        *outptr.offset(2 as ::core::ffi::c_int as isize) =
            *range_limit.offset(((tmp2 + tmp5) as ::core::ffi::c_int & RANGE_MASK) as isize);
        *outptr.offset(5 as ::core::ffi::c_int as isize) =
            *range_limit.offset(((tmp2 - tmp5) as ::core::ffi::c_int & RANGE_MASK) as isize);
        *outptr.offset(3 as ::core::ffi::c_int as isize) =
            *range_limit.offset(((tmp3 + tmp4) as ::core::ffi::c_int & RANGE_MASK) as isize);
        *outptr.offset(4 as ::core::ffi::c_int as isize) =
            *range_limit.offset(((tmp3 - tmp4) as ::core::ffi::c_int & RANGE_MASK) as isize);
