...
unsafe extern "C" fn get_byte(mut cinfo: j_decompress_ptr) -> ::core::ffi::c_int {
    let mut src: *mut jpeg_source_mgr = (*cinfo).src as *mut jpeg_source_mgr;
    if (*src).bytes_in_buffer == 0 as size_t {
    ...
    let fresh1 = (*src).next_input_byte;
    (*src).next_input_byte = (*src).next_input_byte.offset(1);
    return *fresh1 as ::core::ffi::c_int;
}
unsafe extern "C" fn arith_decode(
    ...
    while (*e).a < 0x8000 as ::core::ffi::c_long {
        (*e).ct -= 1;
        if (*e).ct < 0 as ::core::ffi::c_int {
            if (*cinfo).unread_marker != 0 {
                data = 0 as ::core::ffi::c_int;
            } else {
                data = get_byte(cinfo);
                if data == 0xff as ::core::ffi::c_int {
                    loop {
                        data = get_byte(cinfo);
                        if !(data == 0xff as ::core::ffi::c_int) {
                            break;
            ...
            (*e).c = (*e).c << 8 as ::core::ffi::c_int | data as JLONG;
            (*e).ct += 8 as ::core::ffi::c_int;
            if (*e).ct < 0 as ::core::ffi::c_int {
                (*e).ct += 1;
                if (*e).ct == 0 as ::core::ffi::c_int {
                    (*e).a = 0x8000 as ::core::ffi::c_long as JLONG;
                }
            }
        }
    ...
    if (*e).c >= temp {
        ...
        if (*e).a < qe {
            (*e).a = qe;
            *st = (sv & 0x80 as ::core::ffi::c_int ^ nm as ::core::ffi::c_int)
                as ::core::ffi::c_uchar;
        } else {
            (*e).a = qe;
            *st = (sv & 0x80 as ::core::ffi::c_int ^ nl as ::core::ffi::c_int)
                as ::core::ffi::c_uchar;
            sv ^= 0x80 as ::core::ffi::c_int;
        }
    } else if (*e).a < 0x8000 as ::core::ffi::c_long {
        if (*e).a < qe {
            *st = (sv & 0x80 as ::core::ffi::c_int ^ nl as ::core::ffi::c_int)
                as ::core::ffi::c_uchar;
            sv ^= 0x80 as ::core::ffi::c_int;
...
unsafe extern "C" fn process_restart(mut cinfo: j_decompress_ptr) {
    ...
    while ci < (*cinfo).comps_in_scan {
        ...
        {
            memset(
                (*entropy).dc_stats[(*compptr).dc_tbl_no as usize]
        ...
        if (*cinfo).progressive_mode == 0 || (*cinfo).Ss != 0 {
            memset(
                (*entropy).ac_stats[(*compptr).ac_tbl_no as usize]
                    as *mut ::core::ffi::c_void,
                0 as ::core::ffi::c_int,
    ...
    (*entropy).a = 0 as JLONG;
    (*entropy).ct = -(16 as ::core::ffi::c_int);
...
unsafe extern "C" fn decode_mcu_DC_first(
    ...
    let mut st: *mut ::core::ffi::c_uchar = ::core::ptr::null_mut::<
        ::core::ffi::c_uchar,
    >();
    ...
    if (*entropy).ct == -(1 as ::core::ffi::c_int) {
        return TRUE;
    }
    ...
    while blkn < (*cinfo).blocks_in_MCU {
        ...
        st = (*entropy)
            .dc_stats[tbl as usize]
            .offset((*entropy).dc_context[ci as usize] as isize);
        if arith_decode(cinfo, st) == 0 as ::core::ffi::c_int {
            (*entropy).dc_context[ci as usize] = 0 as ::core::ffi::c_int;
        } else {
            sign = arith_decode(cinfo, st.offset(1 as ::core::ffi::c_int as isize));
            st = st.offset(2 as ::core::ffi::c_int as isize);
            st = st.offset(sign as isize);
            m = arith_decode(cinfo, st);
            if m != 0 as ::core::ffi::c_int {
                ...
                while arith_decode(cinfo, st) != 0 {
                    ...
                    if m == 0x8000 as ::core::ffi::c_int {
                        (*(*cinfo).err).msg_code = JWRN_ARITH_BAD_CODE
                            as ::core::ffi::c_int;
                        Some(
                                (*(*cinfo).err)
                                    .emit_message
                        ...
                        (*entropy).ct = -(1 as ::core::ffi::c_int);
                        return TRUE;
                    }
                    ...
                    >> 1 as ::core::ffi::c_int) as ::core::ffi::c_int
            {
                ...
                > ((1 as ::core::ffi::c_long)
                    ...
                    >> 1 as ::core::ffi::c_int) as ::core::ffi::c_int
            {
                (*entropy).dc_context[ci as usize] = 12 as ::core::ffi::c_int
                    + sign * 4 as ::core::ffi::c_int;
            } else {
            ...
            (*entropy).last_dc_val[ci as usize] = (*entropy).last_dc_val[ci as usize] + v
                & 0xffff as ::core::ffi::c_int;
        }
        (*block)[0 as ::core::ffi::c_int as usize] = (((*entropy)
            .last_dc_val[ci as usize] as ::core::ffi::c_ulong) << (*cinfo).Al) as JLONG
            as JCOEF;
        blkn += 1;
    }
    return TRUE;
...
unsafe extern "C" fn decode_mcu_AC_first(
    ...
    while k <= (*cinfo).Se {
        st = (*entropy)
            .ac_stats[tbl as usize]
            .offset((3 as ::core::ffi::c_int * (k - 1 as ::core::ffi::c_int)) as isize);
        if arith_decode(cinfo, st) != 0 {
            break;
        }
        while arith_decode(cinfo, st.offset(1 as ::core::ffi::c_int as isize))
            == 0 as ::core::ffi::c_int
        {
            st = st.offset(3 as ::core::ffi::c_int as isize);
            k += 1;
            if k > (*cinfo).Se {
                (*(*cinfo).err).msg_code = JWRN_ARITH_BAD_CODE as ::core::ffi::c_int;
        ...
        (*block)[*(&raw const jpeg_natural_order as *const ::core::ffi::c_int)
            .offset(k as isize) as usize] = ((v as ::core::ffi::c_uint) << (*cinfo).Al)
            as JCOEF;
        k += 1;
    }
    return TRUE;
...
unsafe extern "C" fn decode_mcu_DC_refine(
    ...
    p1 = (1 as ::core::ffi::c_int) << (*cinfo).Al;
    blkn = 0 as ::core::ffi::c_int;
    while blkn < (*cinfo).blocks_in_MCU {
        if arith_decode(cinfo, st) != 0 {
            let ref mut fresh2 = (*(*MCU_data.offset(blkn as isize))
                .offset(
                    0 as ::core::ffi::c_int as isize,
                ))[0 as ::core::ffi::c_int as usize];
            *fresh2 = (*fresh2 as ::core::ffi::c_int | p1) as JCOEF;
        }
        blkn += 1;
    }
    return TRUE;
    ...
    while k <= (*cinfo).Se {
        ...
        loop {
            thiscoef = (&raw mut *block as *mut JCOEF)
                .offset(
                    *(&raw const jpeg_natural_order as *const ::core::ffi::c_int)
                        .offset(k as isize) as isize,
                ) as JCOEFPTR;
            if *thiscoef != 0 {
                if arith_decode(cinfo, st.offset(2 as ::core::ffi::c_int as isize)) != 0
                {
                ...
                break;
            } else if arith_decode(cinfo, st.offset(1 as ::core::ffi::c_int as isize))
                != 0
            {
                if arith_decode(
                    cinfo,
...
unsafe extern "C" fn decode_mcu(
    ...
    while blkn < (*cinfo).blocks_in_MCU {
        ...
        if !block.is_null() {
            (*block)[0 as ::core::ffi::c_int as usize] = (*entropy)
                .last_dc_val[ci as usize] as JCOEF;
        }
        tbl = (*compptr).ac_tbl_no;
        k = 1 as ::core::ffi::c_int;
        while k <= DCTSIZE2 - 1 as ::core::ffi::c_int {
            st = (*entropy)
                .ac_stats[tbl as usize]
                .offset(
                    (3 as ::core::ffi::c_int * (k - 1 as ::core::ffi::c_int)) as isize,
                );
            if arith_decode(cinfo, st) != 0 {
                break;
            }
            ...
            if m != 0 as ::core::ffi::c_int {
                if arith_decode(cinfo, st) != 0 {
                    ...
                    st = (*entropy)
                        ...
                        .offset(
                            (if k
                                <= (*cinfo).arith_ac_K[tbl as usize] as ::core::ffi::c_int
                            {
                                189 as ::core::ffi::c_int
                            } else {
                                217 as ::core::ffi::c_int
            ...
            if !block.is_null() {
                (*block)[*(&raw const jpeg_natural_order as *const ::core::ffi::c_int)
                    .offset(k as isize) as usize] = v as JCOEF;
            }
            k += 1;
        }
        blkn += 1;
    ...
    if (*cinfo).progressive_mode != 0 {
        if (*cinfo).Ss == 0 as ::core::ffi::c_int {
            if (*cinfo).Se != 0 as ::core::ffi::c_int {
                current_block = 5166366274891130397;
            } else {
                current_block = 10879442775620481940;
            }
        } else if (*cinfo).Se < (*cinfo).Ss
            || (*cinfo).Se > DCTSIZE2 - 1 as ::core::ffi::c_int
        {
            current_block = 5166366274891130397;
        } else if (*cinfo).comps_in_scan != 1 as ::core::ffi::c_int {
            current_block = 5166366274891130397;
        } else {
            current_block = 10879442775620481940;
        }
        match current_block {
            10879442775620481940 => {
                if (*cinfo).Ah != 0 as ::core::ffi::c_int {
                    if (*cinfo).Ah - 1 as ::core::ffi::c_int != (*cinfo).Al {
                        current_block = 5166366274891130397;
                    } else {
        ...
        match current_block {
            5166366274891130397 => {
                ...
                (*(*cinfo).err).msg_parm.i[0 as ::core::ffi::c_int as usize] = (*cinfo)
                    .Ss;
                (*(*cinfo).err).msg_parm.i[1 as ::core::ffi::c_int as usize] = (*cinfo)
                    .Se;
                (*(*cinfo).err).msg_parm.i[2 as ::core::ffi::c_int as usize] = (*cinfo)
                    .Ah;
                (*(*cinfo).err).msg_parm.i[3 as ::core::ffi::c_int as usize] = (*cinfo)
                    .Al;
                Some((*(*cinfo).err).error_exit.expect("non-null function pointer"))
                    .expect("non-null function pointer")(cinfo as j_common_ptr);
            }
        ...
        while ci < (*cinfo).comps_in_scan {
            ...
            let mut cindex: ::core::ffi::c_int = (*(*cinfo).cur_comp_info[ci as usize])
                .component_index;
            let mut coef_bit_ptr: *mut ::core::ffi::c_int = (&raw mut *(*cinfo)
                .coef_bits
                .offset(cindex as isize) as *mut ::core::ffi::c_int)
                .offset(0 as ::core::ffi::c_int as isize) as *mut ::core::ffi::c_int;
            let mut prev_coef_bit_ptr: *mut ::core::ffi::c_int = (&raw mut *(*cinfo)
                .coef_bits
            ...
            while coefi <= (*cinfo).Se {
                ...
                if (*cinfo).Ah != expected {
                    (*(*cinfo).err).msg_code = JWRN_BOGUS_PROGRESSION
                        as ::core::ffi::c_int;
                    (*(*cinfo).err).msg_parm.i[0 as ::core::ffi::c_int as usize] = cindex;
                ...
                && (*cinfo).Ah == 0 as ::core::ffi::c_int
        {
            ...
            if (*entropy).dc_stats[tbl as usize].is_null() {
                (*entropy).dc_stats[tbl as usize] = Some(
                    ...
                    .expect(
                        "non-null function pointer",
                    )(cinfo as j_common_ptr, JPOOL_IMAGE, DC_STAT_BINS as size_t)
        ...
        if (*cinfo).progressive_mode == 0 || (*cinfo).Ss != 0 {
            ...
            if (*entropy).ac_stats[tbl as usize].is_null() {
                (*entropy).ac_stats[tbl as usize] = Some(
                    ...
                    .expect(
                        "non-null function pointer",
                    )(cinfo as j_common_ptr, JPOOL_IMAGE, AC_STAT_BINS as size_t)
                    as *mut ::core::ffi::c_uchar;
            }
            memset(
...
pub unsafe extern "C" fn jinit_arith_decoder(mut cinfo: j_decompress_ptr) {
    let mut entropy: arith_entropy_ptr = ::core::ptr::null_mut::<
    ...
    entropy = Some((*(*cinfo).mem).alloc_small.expect("non-null function pointer"))
        ...
        JPOOL_IMAGE,
        ::core::mem::size_of::<arith_entropy_decoder>() as size_t,
    ...
    (*entropy).pub_0.start_pass = Some(
        start_pass as unsafe extern "C" fn(j_decompress_ptr) -> (),
    ) as Option<unsafe extern "C" fn(j_decompress_ptr) -> ()>;
    i = 0 as ::core::ffi::c_int;
    while i < NUM_ARITH_TBLS {
        (*entropy).dc_stats[i as usize] = ::core::ptr::null_mut::<
            ::core::ffi::c_uchar,
        >();
        (*entropy).ac_stats[i as usize] = ::core::ptr::null_mut::<
            ::core::ffi::c_uchar,
        >();
        i += 1;
    }
