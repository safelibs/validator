#!/usr/bin/env bash
# @testcase: usage-python3-pil-rotate-jpeg
# @title: Pillow rotates JPEG
# @description: Rotates a JPEG with Pillow and verifies the rotated dimensions.
# @timeout: 180
...
case_id="usage-python3-pil-rotate-jpeg"
tmpdir=$(mktemp -d)
