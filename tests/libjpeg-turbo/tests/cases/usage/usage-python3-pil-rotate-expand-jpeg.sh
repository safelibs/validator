#!/usr/bin/env bash
# @testcase: usage-python3-pil-rotate-expand-jpeg
# @title: python PIL rotate expand JPEG
# @description: Exercises python pil rotate expand jpeg through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-rotate-expand-jpeg"
tmpdir=$(mktemp -d)
