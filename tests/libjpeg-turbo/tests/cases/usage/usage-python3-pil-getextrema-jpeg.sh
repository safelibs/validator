#!/usr/bin/env bash
# @testcase: usage-python3-pil-getextrema-jpeg
# @title: python PIL getextrema JPEG
# @description: Exercises python pil getextrema jpeg through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-getextrema-jpeg"
tmpdir=$(mktemp -d)
