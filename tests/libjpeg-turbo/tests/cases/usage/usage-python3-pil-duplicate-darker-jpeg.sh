#!/usr/bin/env bash
# @testcase: usage-python3-pil-duplicate-darker-jpeg
# @title: Pillow duplicate darker JPEG
# @description: Uses Pillow ImageChops.darker on a generated JPEG against its own copy and verifies the result equals the original pixel values before round-tripping.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-duplicate-darker-jpeg"
tmpdir=$(mktemp -d)
