#!/usr/bin/env bash
# @testcase: usage-python3-pil-offset-jpeg
# @title: python PIL offset JPEG
# @description: Exercises python pil offset jpeg through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-offset-jpeg"
tmpdir=$(mktemp -d)
