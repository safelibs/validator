#!/usr/bin/env bash
# @testcase: usage-python3-pil-pad-jpeg
# @title: python PIL pad JPEG
# @description: Exercises python pil pad jpeg through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-pad-jpeg"
tmpdir=$(mktemp -d)
