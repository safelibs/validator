#!/usr/bin/env bash
# @testcase: usage-python3-pil-blend-zero-mirror-jpeg
# @title: Pillow blend alpha zero JPEG
# @description: Uses Pillow Image.blend with alpha zero on a generated JPEG and verifies the result equals the original image pixel-for-pixel before round-tripping.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-blend-zero-mirror-jpeg"
tmpdir=$(mktemp -d)
