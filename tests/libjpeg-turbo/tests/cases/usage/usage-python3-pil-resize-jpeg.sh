#!/usr/bin/env bash
# @testcase: usage-python3-pil-resize-jpeg
# @title: Pillow resizes JPEG
# @description: Opens a JPEG with Pillow, resizes it, saves JPEG output, and verifies dimensions.
# @timeout: 180
...
case_id="usage-python3-pil-resize-jpeg"
tmpdir=$(mktemp -d)
