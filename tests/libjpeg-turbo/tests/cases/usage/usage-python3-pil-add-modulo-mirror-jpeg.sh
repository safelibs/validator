#!/usr/bin/env bash
# @testcase: usage-python3-pil-add-modulo-mirror-jpeg
# @title: Pillow add_modulo mirror JPEG
# @description: Uses Pillow ImageChops.add_modulo on a generated JPEG and its mirrored copy and verifies the modular per-channel sums before round-tripping.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-add-modulo-mirror-jpeg"
tmpdir=$(mktemp -d)
