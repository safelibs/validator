#!/usr/bin/env bash
# @testcase: usage-python3-pil-thumbnail-jpeg
# @title: Pillow thumbnail jpeg
# @description: Uses Pillow to thumbnail jpeg through libjpeg-turbo.
# @timeout: 180
...
import sys
im=Image.open(sys.argv[1]); im.thumbnail((2,2)); print('thumb', im.size)
PY
