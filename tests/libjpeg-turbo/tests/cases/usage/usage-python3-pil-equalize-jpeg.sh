#!/usr/bin/env bash
# @testcase: usage-python3-pil-equalize-jpeg
# @title: python PIL equalize JPEG
# @description: Exercises python pil equalize jpeg through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-equalize-jpeg"
tmpdir=$(mktemp -d)
