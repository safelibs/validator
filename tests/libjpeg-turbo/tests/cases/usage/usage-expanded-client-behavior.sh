...
with Image.open(source) as opened:
    ...
    if case_id == 'usage-python3-pil-transverse-generated-jpeg':
        ...
        round_trip(out)
        print(out.size)
    elif case_id == 'usage-python3-pil-blend-mirror-jpeg':
        ...
        round_trip(out)
        print(expected)
    elif case_id == 'usage-python3-pil-composite-halves-jpeg':
