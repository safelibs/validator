#!/usr/bin/env bash
# @testcase: usage-python3-pil-grayscale-add-jpeg
# @title: Pillow grayscale add JPEG
# @description: Converts a generated JPEG to L mode and adds its mirrored copy with ImageChops.add, verifying the saturated luminance sum before saving.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-grayscale-add-jpeg"
tmpdir=$(mktemp -d)
