#!/usr/bin/env bash
# @testcase: usage-python3-pil-invert-generated-jpeg
# @title: Pillow invert generated JPEG
# @description: Uses Pillow ImageOps.invert on a generated JPEG and verifies the inverted channel values before round-tripping.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-invert-generated-jpeg"
tmpdir=$(mktemp -d)
