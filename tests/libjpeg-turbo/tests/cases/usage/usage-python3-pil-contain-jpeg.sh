#!/usr/bin/env bash
# @testcase: usage-python3-pil-contain-jpeg
# @title: python PIL contain JPEG
# @description: Exercises python pil contain jpeg through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-contain-jpeg"
tmpdir=$(mktemp -d)
