#!/usr/bin/env bash
# @testcase: usage-python3-pil-difference-mirror-jpeg
# @title: Pillow difference mirror JPEG
# @description: Uses Pillow ImageChops.difference on a generated JPEG and its mirrored copy and verifies the absolute per-channel difference values before round-tripping.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-difference-mirror-jpeg"
tmpdir=$(mktemp -d)
