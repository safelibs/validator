#!/usr/bin/env bash
# @testcase: usage-python3-pil-stat-mean-jpeg
# @title: python PIL stat mean JPEG
# @description: Exercises python pil stat mean jpeg through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-stat-mean-jpeg"
tmpdir=$(mktemp -d)
