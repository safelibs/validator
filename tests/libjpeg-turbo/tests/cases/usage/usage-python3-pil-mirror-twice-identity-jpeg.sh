#!/usr/bin/env bash
# @testcase: usage-python3-pil-mirror-twice-identity-jpeg
# @title: Pillow mirror twice identity JPEG
# @description: Mirrors a generated JPEG twice with ImageOps.mirror and verifies the result matches the original pixel-for-pixel before round-tripping.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-mirror-twice-identity-jpeg"
tmpdir=$(mktemp -d)
