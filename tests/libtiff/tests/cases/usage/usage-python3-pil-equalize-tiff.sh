#!/usr/bin/env bash
# @testcase: usage-python3-pil-equalize-tiff
# @title: python PIL equalize TIFF
# @description: Exercises python pil equalize tiff through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-equalize-tiff"
tmpdir=$(mktemp -d)
