#!/usr/bin/env bash
# @testcase: usage-python3-pil-tiff-to-bmp
# @title: Pillow TIFF to BMP
# @description: Converts a TIFF fixture to BMP with Pillow and verifies BMP output.
# @timeout: 180
...
case_id="usage-python3-pil-tiff-to-bmp"
tmpdir=$(mktemp -d)
