#!/usr/bin/env bash
# @testcase: usage-python3-pil-quantize-tiff
# @title: python PIL quantize TIFF
# @description: Exercises python pil quantize tiff through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-quantize-tiff"
tmpdir=$(mktemp -d)
