#!/usr/bin/env bash
# @testcase: usage-python3-pil-stat-mean-tiff
# @title: python PIL stat mean TIFF
# @description: Exercises python pil stat mean tiff through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-stat-mean-tiff"
tmpdir=$(mktemp -d)
