#!/usr/bin/env bash
# @testcase: usage-python3-pil-border-expand-tiff
# @title: python PIL border expand TIFF
# @description: Exercises python pil border expand tiff through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-border-expand-tiff"
tmpdir=$(mktemp -d)
