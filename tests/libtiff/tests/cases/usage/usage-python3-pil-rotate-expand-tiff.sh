#!/usr/bin/env bash
# @testcase: usage-python3-pil-rotate-expand-tiff
# @title: python PIL rotate expand TIFF
# @description: Exercises python pil rotate expand tiff through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-rotate-expand-tiff"
tmpdir=$(mktemp -d)
