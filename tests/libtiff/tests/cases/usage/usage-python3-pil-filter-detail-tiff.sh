#!/usr/bin/env bash
# @testcase: usage-python3-pil-filter-detail-tiff
# @title: python PIL detail filter TIFF
# @description: Exercises python pil detail filter tiff through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-filter-detail-tiff"
tmpdir=$(mktemp -d)
