#!/usr/bin/env bash
# @testcase: usage-python3-pil-fit-tiff
# @title: python PIL fit TIFF
# @description: Exercises python pil fit tiff through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-fit-tiff"
tmpdir=$(mktemp -d)
