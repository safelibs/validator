#!/usr/bin/env bash
# @testcase: usage-python3-pil-red-channel-tiff
# @title: python PIL red channel TIFF
# @description: Exercises python pil red channel tiff through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-red-channel-tiff"
tmpdir=$(mktemp -d)
