#!/usr/bin/env bash
# @testcase: usage-python3-pil-packbits-tiff
# @title: Pillow PackBits TIFF
# @description: Writes PackBits-compressed TIFF data with Pillow and verifies dimensions.
# @timeout: 180
...
case_id="usage-python3-pil-packbits-tiff"
tmpdir=$(mktemp -d)
