#!/usr/bin/env bash
# @testcase: usage-python3-pil-crop-generated-tiff
# @title: python PIL crop generated TIFF
# @description: Exercises python pil crop generated tiff through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-crop-generated-tiff"
tmpdir=$(mktemp -d)
