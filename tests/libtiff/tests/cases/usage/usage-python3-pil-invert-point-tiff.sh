#!/usr/bin/env bash
# @testcase: usage-python3-pil-invert-point-tiff
# @title: python PIL invert point TIFF
# @description: Exercises python pil invert point tiff through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-invert-point-tiff"
tmpdir=$(mktemp -d)
