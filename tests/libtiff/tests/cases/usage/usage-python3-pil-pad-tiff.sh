#!/usr/bin/env bash
# @testcase: usage-python3-pil-pad-tiff
# @title: python PIL pad TIFF
# @description: Exercises python pil pad tiff through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-pad-tiff"
tmpdir=$(mktemp -d)
