#!/usr/bin/env bash
# @testcase: usage-python3-pil-grayscale-tiff
# @title: Pillow grayscale TIFF
# @description: Writes and reopens a grayscale TIFF with Pillow.
# @timeout: 180
...
case_id="usage-python3-pil-grayscale-tiff"
tmpdir=$(mktemp -d)
