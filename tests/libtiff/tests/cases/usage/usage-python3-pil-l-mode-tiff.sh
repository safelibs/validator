#!/usr/bin/env bash
# @testcase: usage-python3-pil-l-mode-tiff
# @title: python PIL L mode TIFF
# @description: Exercises python pil l mode tiff through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-l-mode-tiff"
tmpdir=$(mktemp -d)
