#!/usr/bin/env bash
# @testcase: usage-python3-pil-flip-topbottom-tiff
# @title: Pillow flips TIFF vertically
# @description: Flips a TIFF fixture vertically with Pillow and verifies the output size.
# @timeout: 180
...
case_id="usage-python3-pil-flip-topbottom-tiff"
tmpdir=$(mktemp -d)
