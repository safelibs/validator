#!/usr/bin/env bash
# @testcase: usage-libarchive-tools-xz-batch11-exclude-vcs
# @title: bsdtar xz exclude VCS
# @description: Creates an xz archive with VCS metadata excluded by bsdtar.
# @timeout: 180
...
case_id="usage-libarchive-tools-xz-batch11-exclude-vcs"
tmpdir=$(mktemp -d)
