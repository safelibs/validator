#!/usr/bin/env bash
# @testcase: usage-readstat-sav-date-string-batch11
# @title: readstat SAV date string
# @description: Preserves a date-like string through readstat SAV conversion.
# @timeout: 180
...
case_id="usage-readstat-sav-date-string-batch11"
tmpdir=$(mktemp -d)
