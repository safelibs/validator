#!/usr/bin/env bash
# @testcase: usage-readstat-sav-long-string
# @title: readstat SAV long string
# @description: Converts a longer string field through SAV and verifies the text survives.
# @timeout: 180
# @tags: usage, csv
# @client: readstat
...
case_id="usage-readstat-sav-long-string"
tmpdir=$(mktemp -d)
