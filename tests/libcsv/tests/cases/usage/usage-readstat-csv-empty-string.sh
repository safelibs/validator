#!/usr/bin/env bash
# @testcase: usage-readstat-csv-empty-string
# @title: readstat empty string field
# @description: Converts an empty string field through DTA and verifies the row is preserved.
# @timeout: 180
# @tags: usage, csv
# @client: readstat
...
case_id="usage-readstat-csv-empty-string"
tmpdir=$(mktemp -d)
