#!/usr/bin/env bash
# @testcase: usage-readstat-sav-column-count
# @title: readstat SAV column count
# @description: Writes a SAV dataset and verifies readstat reports the expected column count.
# @timeout: 180
# @tags: usage, csv
# @client: readstat
...
case_id="usage-readstat-sav-column-count"
tmpdir=$(mktemp -d)
