#!/usr/bin/env bash
# @testcase: usage-readstat-sav-slash-note
# @title: readstat SAV slash note
# @description: Converts a slash-delimited text field through SAV and verifies the punctuation survives export.
# @timeout: 180
# @tags: usage, csv
# @client: readstat
...
case_id="usage-readstat-sav-slash-note"
tmpdir=$(mktemp -d)
