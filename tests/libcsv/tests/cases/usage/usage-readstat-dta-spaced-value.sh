#!/usr/bin/env bash
# @testcase: usage-readstat-dta-spaced-value
# @title: readstat spaced string value
# @description: Converts a string containing spaces through DTA and verifies output quoting.
# @timeout: 180
# @tags: usage, csv
# @client: readstat
...
case_id="usage-readstat-dta-spaced-value"
tmpdir=$(mktemp -d)
