#!/usr/bin/env bash
# @testcase: usage-readstat-sav-comma-value
# @title: readstat comma string value
# @description: Converts a string containing a comma through SAV and verifies CSV escaping.
# @timeout: 180
# @tags: usage, csv
# @client: readstat
...
case_id="usage-readstat-sav-comma-value"
tmpdir=$(mktemp -d)
