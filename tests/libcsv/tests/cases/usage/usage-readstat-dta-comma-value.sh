#!/usr/bin/env bash
# @testcase: usage-readstat-dta-comma-value
# @title: readstat DTA comma value
# @description: Converts a quoted comma-containing string through DTA and verifies the field survives export.
# @timeout: 180
# @tags: usage, csv
# @client: readstat
...
case_id="usage-readstat-dta-comma-value"
tmpdir=$(mktemp -d)
