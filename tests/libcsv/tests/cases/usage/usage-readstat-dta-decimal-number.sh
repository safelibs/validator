#!/usr/bin/env bash
# @testcase: usage-readstat-dta-decimal-number
# @title: readstat DTA decimal number
# @description: Converts decimal numeric data through DTA and verifies numeric formatting.
# @timeout: 180
# @tags: usage, csv
# @client: readstat
...
case_id="usage-readstat-dta-decimal-number"
tmpdir=$(mktemp -d)
