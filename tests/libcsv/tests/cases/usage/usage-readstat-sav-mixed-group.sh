#!/usr/bin/env bash
# @testcase: usage-readstat-sav-mixed-group
# @title: readstat SAV mixed group value
# @description: Exercises readstat sav mixed group value through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: readstat
...
case_id="usage-readstat-sav-mixed-group"
tmpdir=$(mktemp -d)
