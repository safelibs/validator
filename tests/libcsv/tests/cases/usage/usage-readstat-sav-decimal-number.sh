#!/usr/bin/env bash
# @testcase: usage-readstat-sav-decimal-number
# @title: readstat SAV decimal number
# @description: Converts decimal numeric data through SAV and verifies numeric formatting.
# @timeout: 180
# @tags: usage, csv
# @client: readstat
...
case_id="usage-readstat-sav-decimal-number"
tmpdir=$(mktemp -d)
