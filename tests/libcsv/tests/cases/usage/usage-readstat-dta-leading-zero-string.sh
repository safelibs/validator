#!/usr/bin/env bash
# @testcase: usage-readstat-dta-leading-zero-string
# @title: readstat DTA leading zero string
# @description: Converts a string field with leading zeros through DTA and verifies the leading zeros survive export.
# @timeout: 180
# @tags: usage, csv
# @client: readstat
...
case_id="usage-readstat-dta-leading-zero-string"
tmpdir=$(mktemp -d)
