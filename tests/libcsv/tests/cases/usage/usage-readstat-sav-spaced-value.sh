#!/usr/bin/env bash
# @testcase: usage-readstat-sav-spaced-value
# @title: readstat SAV spaced value
# @description: Converts a spaced string field through SAV and verifies the text survives export.
# @timeout: 180
# @tags: usage, csv
# @client: readstat
...
case_id="usage-readstat-sav-spaced-value"
tmpdir=$(mktemp -d)
