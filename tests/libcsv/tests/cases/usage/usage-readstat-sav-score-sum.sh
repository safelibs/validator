#!/usr/bin/env bash
# @testcase: usage-readstat-sav-score-sum
# @title: readstat SAV score sum
# @description: Converts multiple CSV rows through SAV and verifies numeric score aggregation over the exported data.
# @timeout: 180
# @tags: usage, csv
# @client: readstat
...
case_id="usage-readstat-sav-score-sum"
tmpdir=$(mktemp -d)
