#!/usr/bin/env bash
# @testcase: usage-python3-lxml-xpath-sum-weight
# @title: lxml XPath sum weight
# @description: Sums the weight attribute across item elements with python3-lxml and verifies the aggregated total.
# @timeout: 180
...
case_id="usage-python3-lxml-xpath-sum-weight"
tmpdir=$(mktemp -d)
