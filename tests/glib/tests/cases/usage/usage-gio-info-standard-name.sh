#!/usr/bin/env bash
# @testcase: usage-gio-info-standard-name
# @title: gio info standard name
# @description: Exercises gio info standard name through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: gio
...
case_id="usage-gio-info-standard-name"
tmpdir=$(mktemp -d)
