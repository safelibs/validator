#!/usr/bin/env bash
# @testcase: usage-gio-move-renamed-file
# @title: gio move renamed file
# @description: Exercises gio move renamed file through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: gio
...
case_id="usage-gio-move-renamed-file"
tmpdir=$(mktemp -d)
