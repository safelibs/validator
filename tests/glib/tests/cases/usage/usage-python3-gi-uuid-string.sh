#!/usr/bin/env bash
# @testcase: usage-python3-gi-uuid-string
# @title: PyGObject UUID string
# @description: Generates a UUID string through GLib and verifies canonical formatting.
# @timeout: 180
...
case_id="usage-python3-gi-uuid-string"
tmpdir=$(mktemp -d)
