#!/usr/bin/env bash
# @testcase: usage-glib-compile-schemas-int-array
# @title: glib compile schemas int array default
# @description: Exercises glib compile schemas int array default through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: gio
...
case_id="usage-glib-compile-schemas-int-array"
tmpdir=$(mktemp -d)
