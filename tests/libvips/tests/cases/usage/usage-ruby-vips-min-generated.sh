#!/usr/bin/env bash
# @testcase: usage-ruby-vips-min-generated
# @title: ruby-vips generated min
# @description: Exercises ruby-vips generated min through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: ruby-vips
...
case_id="usage-ruby-vips-min-generated"
tmpdir=$(mktemp -d)
