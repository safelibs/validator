#!/usr/bin/env bash
# @testcase: usage-ruby-vips-bandmean-rgb-batch11
# @title: ruby-vips RGB bandmean
# @description: Computes the band mean for an RGB pixel with ruby-vips.
# @timeout: 180
...
case_id="usage-ruby-vips-bandmean-rgb-batch11"
tmpdir=$(mktemp -d)
