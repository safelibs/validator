#!/usr/bin/env bash
# @testcase: usage-ruby-vips-zoom-generated
# @title: ruby-vips generated zoom
# @description: Exercises ruby-vips generated zoom through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: ruby-vips
...
case_id="usage-ruby-vips-zoom-generated"
tmpdir=$(mktemp -d)
