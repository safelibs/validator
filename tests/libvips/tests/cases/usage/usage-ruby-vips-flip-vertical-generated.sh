#!/usr/bin/env bash
# @testcase: usage-ruby-vips-flip-vertical-generated
# @title: ruby-vips generated flip vertical
# @description: Flips a generated image vertically with ruby-vips and verifies the reversed pixel order.
# @timeout: 120
# @tags: usage
# @client: ruby-vips
...
case_id="usage-ruby-vips-flip-vertical-generated"
tmpdir=$(mktemp -d)
