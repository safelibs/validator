#!/usr/bin/env bash
# @testcase: usage-ruby-vips-multiply-constant-generated
# @title: ruby-vips generated multiply constant
# @description: Exercises ruby-vips generated multiply constant through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: ruby-vips
...
case_id="usage-ruby-vips-multiply-constant-generated"
tmpdir=$(mktemp -d)
