#!/usr/bin/env bash
# @testcase: usage-ruby-vips-max-generated
# @title: ruby-vips generated max
# @description: Exercises ruby-vips generated max through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: ruby-vips
...
case_id="usage-ruby-vips-max-generated"
tmpdir=$(mktemp -d)
