#!/usr/bin/env bash
# @testcase: usage-iperf3-json-r20-udp-end-sum-jitter-ms-le-100
# @title: iperf3 -J -u loopback end.sum.jitter_ms is bounded above by 100 ms
...
# @timeout: 180
# @tags: usage, json, udp, jitter, r20
# @client: iperf3
