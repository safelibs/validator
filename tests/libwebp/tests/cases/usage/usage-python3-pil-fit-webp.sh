#!/usr/bin/env bash
# @testcase: usage-python3-pil-fit-webp
# @title: python PIL fit WebP
# @description: Exercises python pil fit webp through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-fit-webp"
tmpdir=$(mktemp -d)
