#!/usr/bin/env bash
# @testcase: usage-python3-pil-quantize-webp
# @title: python PIL quantize WebP
# @description: Exercises python pil quantize webp through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-quantize-webp"
tmpdir=$(mktemp -d)
