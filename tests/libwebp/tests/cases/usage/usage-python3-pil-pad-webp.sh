#!/usr/bin/env bash
# @testcase: usage-python3-pil-pad-webp
# @title: python PIL pad WebP
# @description: Exercises python pil pad webp through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-pad-webp"
tmpdir=$(mktemp -d)
