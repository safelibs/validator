#!/usr/bin/env bash
# @testcase: usage-python3-pil-lossless-alpha-webp
# @title: Pillow lossless alpha WebP
# @description: Saves an RGBA lossless WebP image with Pillow and verifies alpha-capable output.
# @timeout: 180
...
case_id="usage-python3-pil-lossless-alpha-webp"
tmpdir=$(mktemp -d)
