#!/usr/bin/env bash
# @testcase: usage-python3-pil-getextrema-webp
# @title: python PIL getextrema WebP
# @description: Exercises python pil getextrema webp through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-getextrema-webp"
tmpdir=$(mktemp -d)
