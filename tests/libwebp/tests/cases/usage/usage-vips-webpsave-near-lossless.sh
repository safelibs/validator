#!/usr/bin/env bash
# @testcase: usage-vips-webpsave-near-lossless
# @title: vips webpsave near_lossless
# @description: Re-encodes a WebP through vips webpsave with near_lossless=true and verifies the output header.
# @timeout: 180
...
vips copy "$tmpdir/in.webp" "$tmpdir/out.webp[near_lossless=true,Q=60]"
