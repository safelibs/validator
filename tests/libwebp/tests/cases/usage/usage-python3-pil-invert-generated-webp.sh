#!/usr/bin/env bash
# @testcase: usage-python3-pil-invert-generated-webp
# @title: Pillow invert generated WebP
# @description: Uses Pillow ImageOps.invert on a generated WebP and verifies the inverted channel values before round-tripping.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-invert-generated-webp"
tmpdir=$(mktemp -d)
