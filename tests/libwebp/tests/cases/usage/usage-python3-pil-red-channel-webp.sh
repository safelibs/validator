#!/usr/bin/env bash
# @testcase: usage-python3-pil-red-channel-webp
# @title: python PIL red channel WebP
# @description: Exercises python pil red channel webp through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-red-channel-webp"
tmpdir=$(mktemp -d)
