#!/usr/bin/env bash
# @testcase: usage-python3-pil-rotate-expand-webp
# @title: python PIL rotate expand WebP
# @description: Exercises python pil rotate expand webp through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: python3-pil
...
case_id="usage-python3-pil-rotate-expand-webp"
tmpdir=$(mktemp -d)
