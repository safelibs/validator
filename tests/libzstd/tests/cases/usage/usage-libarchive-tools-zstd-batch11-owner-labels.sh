#!/usr/bin/env bash
# @testcase: usage-libarchive-tools-zstd-batch11-owner-labels
# @title: bsdtar zstd owner labels
# @description: Writes custom owner labels into a zstd-compressed tar archive and verifies verbose listing output.
# @timeout: 180
...
case_id="usage-libarchive-tools-zstd-batch11-owner-labels"
tmpdir=$(mktemp -d)
