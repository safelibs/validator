#!/usr/bin/env bash
# @testcase: usage-libarchive-tools-zstd-batch11-null-filelist
# @title: bsdtar zstd null file list
# @description: Creates a zstd archive from a null-delimited file list with bsdtar.
# @timeout: 180
...
case_id="usage-libarchive-tools-zstd-batch11-null-filelist"
tmpdir=$(mktemp -d)
