#!/usr/bin/env bash
# @testcase: usage-libarchive-tools-zstd-batch11-filelist-create
# @title: bsdtar zstd file list create
# @description: Creates a zstd archive from a newline-delimited file list and verifies the selected members.
# @timeout: 180
...
case_id="usage-libarchive-tools-zstd-batch11-filelist-create"
tmpdir=$(mktemp -d)
