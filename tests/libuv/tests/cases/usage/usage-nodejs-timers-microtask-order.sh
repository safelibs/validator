#!/usr/bin/env bash
# @testcase: usage-nodejs-timers-microtask-order
# @title: Node.js timers microtask order
# @description: Exercises node.js timers microtask order through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: nodejs
...
case_id="usage-nodejs-timers-microtask-order"
tmpdir=$(mktemp -d)
