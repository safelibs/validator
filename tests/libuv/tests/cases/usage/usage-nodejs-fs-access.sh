#!/usr/bin/env bash
# @testcase: usage-nodejs-fs-access
# @title: Node.js fs access
# @description: Exercises node.js fs access through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: nodejs
...
case_id="usage-nodejs-fs-access"
tmpdir=$(mktemp -d)
