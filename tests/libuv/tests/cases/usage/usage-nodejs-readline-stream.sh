#!/usr/bin/env bash
# @testcase: usage-nodejs-readline-stream
# @title: Node.js readline stream
# @description: Consumes stream lines with Node.js readline and verifies line count.
# @timeout: 180
...
case_id="usage-nodejs-readline-stream"
tmpdir=$(mktemp -d)
