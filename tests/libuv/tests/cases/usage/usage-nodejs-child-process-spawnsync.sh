#!/usr/bin/env bash
# @testcase: usage-nodejs-child-process-spawnsync
# @title: Node.js child process spawnSync
# @description: Exercises node.js child process spawnsync through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: nodejs
...
case_id="usage-nodejs-child-process-spawnsync"
tmpdir=$(mktemp -d)
