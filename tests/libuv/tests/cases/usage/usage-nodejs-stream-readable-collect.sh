#!/usr/bin/env bash
# @testcase: usage-nodejs-stream-readable-collect
# @title: Node.js stream readable collect
# @description: Exercises node.js stream readable collect through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: nodejs
...
case_id="usage-nodejs-stream-readable-collect"
tmpdir=$(mktemp -d)
