#!/usr/bin/env bash
# @testcase: usage-nodejs-dgram-connect-send
# @title: Node.js dgram connect send
# @description: Exercises node.js dgram connect send through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: nodejs
...
case_id="usage-nodejs-dgram-connect-send"
tmpdir=$(mktemp -d)
