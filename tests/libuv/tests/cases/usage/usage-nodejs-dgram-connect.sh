#!/usr/bin/env bash
# @testcase: usage-nodejs-dgram-connect
# @title: Node.js UDP connect
# @description: Sends a UDP datagram over loopback with Node.js dgram APIs.
# @timeout: 180
...
case_id="usage-nodejs-dgram-connect"
tmpdir=$(mktemp -d)
