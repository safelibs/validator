#!/usr/bin/env bash
# @testcase: usage-nodejs-zlib-gzipsync
# @title: Node.js zlib gzipSync
# @description: Exercises node.js zlib gzipsync through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: nodejs
...
case_id="usage-nodejs-zlib-gzipsync"
tmpdir=$(mktemp -d)
