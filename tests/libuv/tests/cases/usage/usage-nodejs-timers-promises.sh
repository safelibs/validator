#!/usr/bin/env bash
# @testcase: usage-nodejs-timers-promises
# @title: Node.js timers promises
# @description: Awaits a timers/promises timeout result and verifies the resolved value.
# @timeout: 180
...
case_id="usage-nodejs-timers-promises"
tmpdir=$(mktemp -d)
