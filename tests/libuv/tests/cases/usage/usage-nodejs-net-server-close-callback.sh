#!/usr/bin/env bash
# @testcase: usage-nodejs-net-server-close-callback
# @title: Node.js net server close callback
# @description: Exercises node.js net server close callback through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: nodejs
...
case_id="usage-nodejs-net-server-close-callback"
tmpdir=$(mktemp -d)
