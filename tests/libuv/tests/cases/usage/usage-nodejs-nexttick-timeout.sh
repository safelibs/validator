#!/usr/bin/env bash
# @testcase: usage-nodejs-nexttick-timeout
# @title: Node.js nextTick and timeout
# @description: Runs nextTick before a timeout and verifies callback ordering.
# @timeout: 180
...
case_id="usage-nodejs-nexttick-timeout"
tmpdir=$(mktemp -d)
