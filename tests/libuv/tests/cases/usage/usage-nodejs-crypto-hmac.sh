#!/usr/bin/env bash
# @testcase: usage-nodejs-crypto-hmac
# @title: Node.js crypto HMAC
# @description: Exercises node.js crypto hmac through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: nodejs
...
case_id="usage-nodejs-crypto-hmac"
tmpdir=$(mktemp -d)
