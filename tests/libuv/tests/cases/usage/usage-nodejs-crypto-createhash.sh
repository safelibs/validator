#!/usr/bin/env bash
# @testcase: usage-nodejs-crypto-createhash
# @title: Node.js crypto hash
# @description: Computes a SHA-256 digest with Node.js crypto.createHash and verifies the prefix.
# @timeout: 180
...
case_id="usage-nodejs-crypto-createhash"
tmpdir=$(mktemp -d)
