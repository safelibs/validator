#!/usr/bin/env bash
# @testcase: usage-nodejs-fs-rename
# @title: Node.js fs rename
# @description: Exercises node.js fs rename through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: nodejs
...
case_id="usage-nodejs-fs-rename"
tmpdir=$(mktemp -d)
