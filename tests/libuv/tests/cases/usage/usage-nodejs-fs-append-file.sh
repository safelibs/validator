#!/usr/bin/env bash
# @testcase: usage-nodejs-fs-append-file
# @title: Node.js fs append file
# @description: Exercises node.js fs append file through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: nodejs
...
case_id="usage-nodejs-fs-append-file"
tmpdir=$(mktemp -d)
