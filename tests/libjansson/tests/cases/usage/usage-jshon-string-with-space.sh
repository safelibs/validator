#!/usr/bin/env bash
# @testcase: usage-jshon-string-with-space
# @title: jshon string with spaces
# @description: Extracts a string containing spaces through jshon unpacking.
# @timeout: 180
# @tags: usage, json
# @client: jshon
...
case_id="usage-jshon-string-with-space"
tmpdir=$(mktemp -d)
