#!/usr/bin/env bash
# @testcase: usage-jshon-batch11-negative-number
# @title: jshon negative number
# @description: Reads a negative fractional number with jshon.
# @timeout: 180
# @tags: usage, json, cli
# @client: jshon
...
case_id="usage-jshon-batch11-negative-number"
tmpdir=$(mktemp -d)
