#!/usr/bin/env bash
# @testcase: usage-jshon-object-length
# @title: jshon object key count
# @description: Counts keys in a JSON object with jshon length output.
# @timeout: 180
# @tags: usage, json
# @client: jshon
...
case_id="usage-jshon-object-length"
tmpdir=$(mktemp -d)
