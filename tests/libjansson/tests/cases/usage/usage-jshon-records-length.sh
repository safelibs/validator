#!/usr/bin/env bash
# @testcase: usage-jshon-records-length
# @title: jshon records length
# @description: Measures a nested JSON array length with jshon and verifies the element count.
# @timeout: 180
# @tags: usage, json
# @client: jshon
...
case_id="usage-jshon-records-length"
tmpdir=$(mktemp -d)
