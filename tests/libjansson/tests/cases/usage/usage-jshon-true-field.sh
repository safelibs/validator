#!/usr/bin/env bash
# @testcase: usage-jshon-true-field
# @title: jshon true field
# @description: Reads a true boolean field with jshon and verifies the unquoted boolean value.
# @timeout: 180
# @tags: usage, json
# @client: jshon
...
case_id="usage-jshon-true-field"
tmpdir=$(mktemp -d)
