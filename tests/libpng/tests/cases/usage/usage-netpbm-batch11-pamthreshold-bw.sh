#!/usr/bin/env bash
# @testcase: usage-netpbm-batch11-pamthreshold-bw
# @title: netpbm pamthreshold black white
# @description: Thresholds a PNG-derived grayscale image to a black-and-white PAM.
# @timeout: 180
...
case_id="usage-netpbm-batch11-pamthreshold-bw"
tmpdir=$(mktemp -d)
