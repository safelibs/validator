#!/usr/bin/env bash
# @testcase: usage-netpbm-pnmdepth-63-png-generated
# @title: netpbm pnmdepth 63 PNG generated
# @description: Reduces a generated grayscale PNG depth to 63 with pnmdepth and verifies the resulting maxval header.
# @timeout: 120
# @tags: usage
# @client: netpbm
...
case_id="usage-netpbm-pnmdepth-63-png-generated"
tmpdir=$(mktemp -d)
