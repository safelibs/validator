#!/usr/bin/env bash
# @testcase: usage-netpbm-batch11-pnmrotate-right-angle
# @title: netpbm pnmrotate right angle
# @description: Rotates a PNG-derived grayscale image with pnmrotate and checks the expanded canvas shape.
# @timeout: 180
...
case_id="usage-netpbm-batch11-pnmrotate-right-angle"
tmpdir=$(mktemp -d)
