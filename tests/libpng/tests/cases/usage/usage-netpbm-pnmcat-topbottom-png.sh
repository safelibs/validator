#!/usr/bin/env bash
# @testcase: usage-netpbm-pnmcat-topbottom-png
# @title: netpbm pnmcat top-bottom PNG
# @description: Exercises netpbm pnmcat top-bottom png through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: netpbm
...
case_id="usage-netpbm-pnmcat-topbottom-png"
tmpdir=$(mktemp -d)
