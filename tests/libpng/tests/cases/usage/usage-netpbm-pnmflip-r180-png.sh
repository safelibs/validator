#!/usr/bin/env bash
# @testcase: usage-netpbm-pnmflip-r180-png
# @title: netpbm pnmflip r180 PNG
# @description: Exercises netpbm pnmflip r180 png through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: netpbm
...
case_id="usage-netpbm-pnmflip-r180-png"
tmpdir=$(mktemp -d)
