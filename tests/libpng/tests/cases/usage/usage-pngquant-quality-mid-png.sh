#!/usr/bin/env bash
# @testcase: usage-pngquant-quality-mid-png
# @title: pngquant mid quality PNG
# @description: Exercises pngquant mid quality png through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: pngquant
...
case_id="usage-pngquant-quality-mid-png"
tmpdir=$(mktemp -d)
