#!/usr/bin/env bash
# @testcase: usage-netpbm-pamchannel-red-generated-png
# @title: netpbm generated PNG red channel
# @description: Exercises netpbm generated png red channel through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: netpbm
...
case_id="usage-netpbm-pamchannel-red-generated-png"
tmpdir=$(mktemp -d)
