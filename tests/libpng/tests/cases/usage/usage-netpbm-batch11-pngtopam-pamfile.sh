#!/usr/bin/env bash
# @testcase: usage-netpbm-batch11-pngtopam-pamfile
# @title: netpbm pngtopam pamfile
# @description: Converts a PNG through pngtopam and verifies PAM metadata with pamfile.
# @timeout: 180
...
case_id="usage-netpbm-batch11-pngtopam-pamfile"
tmpdir=$(mktemp -d)
