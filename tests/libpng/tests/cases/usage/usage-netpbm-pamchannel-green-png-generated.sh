#!/usr/bin/env bash
# @testcase: usage-netpbm-pamchannel-green-png-generated
# @title: netpbm pamchannel green PNG generated
# @description: Extracts the green channel from a generated RGB PNG with pamchannel and verifies the resulting grayscale values.
# @timeout: 120
# @tags: usage
# @client: netpbm
...
case_id="usage-netpbm-pamchannel-green-png-generated"
tmpdir=$(mktemp -d)
