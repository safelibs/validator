#!/usr/bin/env bash
# @testcase: usage-netpbm-batch11-pnmshear-width
# @title: netpbm pnmshear width
# @description: Shears a PNG-derived grayscale image with pnmshear and verifies the expanded width.
# @timeout: 180
...
case_id="usage-netpbm-batch11-pnmshear-width"
tmpdir=$(mktemp -d)
