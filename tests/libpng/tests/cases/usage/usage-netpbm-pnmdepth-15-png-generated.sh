#!/usr/bin/env bash
# @testcase: usage-netpbm-pnmdepth-15-png-generated
# @title: netpbm pnmdepth 15 PNG generated
# @description: Reduces a generated grayscale PNG depth with netpbm and verifies the resulting maxval header.
# @timeout: 120
# @tags: usage
# @client: netpbm
...
case_id="usage-netpbm-pnmdepth-15-png-generated"
tmpdir=$(mktemp -d)
