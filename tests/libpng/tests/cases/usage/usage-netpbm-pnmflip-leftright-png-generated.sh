#!/usr/bin/env bash
# @testcase: usage-netpbm-pnmflip-leftright-png-generated
# @title: netpbm pnmflip leftright PNG generated
# @description: Flips a generated grayscale PNG left-to-right with netpbm and verifies the pixel order in the output image.
# @timeout: 120
# @tags: usage
# @client: netpbm
...
case_id="usage-netpbm-pnmflip-leftright-png-generated"
tmpdir=$(mktemp -d)
