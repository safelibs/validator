#!/usr/bin/env bash
# @testcase: usage-netpbm-pnmscale-half-png
# @title: netpbm pnmscale half PNG
# @description: Exercises netpbm pnmscale half png through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: netpbm
...
case_id="usage-netpbm-pnmscale-half-png"
tmpdir=$(mktemp -d)
