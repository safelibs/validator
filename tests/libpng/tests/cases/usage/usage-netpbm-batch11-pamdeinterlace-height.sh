#!/usr/bin/env bash
# @testcase: usage-netpbm-batch11-pamdeinterlace-height
# @title: netpbm pamdeinterlace height
# @description: Deinterlaces a PNG-derived grayscale image and verifies the reduced field height.
# @timeout: 180
...
case_id="usage-netpbm-batch11-pamdeinterlace-height"
tmpdir=$(mktemp -d)
