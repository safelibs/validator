#!/usr/bin/env bash
# @testcase: usage-netpbm-pnmcut-middle-row-png
# @title: netpbm pnmcut middle row PNG
# @description: Exercises netpbm pnmcut middle row png through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: netpbm
...
case_id="usage-netpbm-pnmcut-middle-row-png"
tmpdir=$(mktemp -d)
