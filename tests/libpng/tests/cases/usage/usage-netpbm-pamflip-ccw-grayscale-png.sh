#!/usr/bin/env bash
# @testcase: usage-netpbm-pamflip-ccw-grayscale-png
# @title: netpbm pamflip ccw grayscale PNG
# @description: Rotates a generated grayscale PNG counter-clockwise with pamflip and verifies the rotated pixel order.
# @timeout: 120
# @tags: usage
# @client: netpbm
...
case_id="usage-netpbm-pamflip-ccw-grayscale-png"
tmpdir=$(mktemp -d)
