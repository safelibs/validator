#!/usr/bin/env bash
# @testcase: usage-netpbm-pamflip-tb-png
# @title: netpbm pamflip topbottom on PNG-derived image
# @description: Round-trips a small image through PNG, flips it top-bottom with pamflip, and checks vertical row reversal.
# @timeout: 180
...
pamflip -topbottom "$tmpdir/in-rt.pgm" >"$tmpdir/flipped.pgm"
assert_values "$tmpdir/flipped.pgm" 1 4 1 '[40, 30, 20, 10]'
