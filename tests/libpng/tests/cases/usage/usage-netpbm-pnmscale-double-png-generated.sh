#!/usr/bin/env bash
# @testcase: usage-netpbm-pnmscale-double-png-generated
# @title: netpbm pnmscale double PNG generated
# @description: Doubles a generated grayscale PNG with netpbm and verifies the scaled output dimensions and pixel values.
# @timeout: 120
# @tags: usage
# @client: netpbm
...
case_id="usage-netpbm-pnmscale-double-png-generated"
tmpdir=$(mktemp -d)
