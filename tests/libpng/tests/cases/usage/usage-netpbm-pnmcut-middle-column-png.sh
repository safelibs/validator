#!/usr/bin/env bash
# @testcase: usage-netpbm-pnmcut-middle-column-png
# @title: netpbm pnmcut middle column PNG
# @description: Exercises netpbm pnmcut middle column png through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: netpbm
...
case_id="usage-netpbm-pnmcut-middle-column-png"
tmpdir=$(mktemp -d)
