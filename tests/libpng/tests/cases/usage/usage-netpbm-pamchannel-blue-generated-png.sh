#!/usr/bin/env bash
# @testcase: usage-netpbm-pamchannel-blue-generated-png
# @title: netpbm generated PNG blue channel
# @description: Exercises netpbm generated png blue channel through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: netpbm
...
case_id="usage-netpbm-pamchannel-blue-generated-png"
tmpdir=$(mktemp -d)
