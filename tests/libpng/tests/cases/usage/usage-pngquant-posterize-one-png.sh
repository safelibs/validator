#!/usr/bin/env bash
# @testcase: usage-pngquant-posterize-one-png
# @title: pngquant posterize one PNG
# @description: Exercises pngquant posterize one png through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: pngquant
...
case_id="usage-pngquant-posterize-one-png"
tmpdir=$(mktemp -d)
