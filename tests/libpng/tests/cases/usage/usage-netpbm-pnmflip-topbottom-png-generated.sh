#!/usr/bin/env bash
# @testcase: usage-netpbm-pnmflip-topbottom-png-generated
# @title: netpbm pnmflip topbottom PNG generated
# @description: Flips a generated grayscale PNG top-to-bottom with netpbm and verifies the pixel order in the output image.
# @timeout: 120
# @tags: usage
# @client: netpbm
...
case_id="usage-netpbm-pnmflip-topbottom-png-generated"
tmpdir=$(mktemp -d)
