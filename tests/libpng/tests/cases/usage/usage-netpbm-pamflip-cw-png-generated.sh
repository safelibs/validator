#!/usr/bin/env bash
# @testcase: usage-netpbm-pamflip-cw-png-generated
# @title: netpbm pamflip cw PNG generated
# @description: Rotates a generated grayscale PNG clockwise with pamflip and verifies the rotated pixel order.
# @timeout: 120
# @tags: usage
# @client: netpbm
...
case_id="usage-netpbm-pamflip-cw-png-generated"
tmpdir=$(mktemp -d)
