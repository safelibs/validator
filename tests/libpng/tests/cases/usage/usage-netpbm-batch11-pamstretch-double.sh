#!/usr/bin/env bash
# @testcase: usage-netpbm-batch11-pamstretch-double
# @title: netpbm pamstretch double
# @description: Stretches a PNG-derived grayscale image with pamstretch and verifies doubled dimensions.
# @timeout: 180
...
case_id="usage-netpbm-batch11-pamstretch-double"
tmpdir=$(mktemp -d)
