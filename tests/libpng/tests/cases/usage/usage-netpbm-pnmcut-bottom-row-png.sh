#!/usr/bin/env bash
# @testcase: usage-netpbm-pnmcut-bottom-row-png
# @title: netpbm bottom row PNG cut
# @description: Exercises netpbm bottom row png cut through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: netpbm
...
case_id="usage-netpbm-pnmcut-bottom-row-png"
tmpdir=$(mktemp -d)
