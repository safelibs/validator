#!/usr/bin/env bash
# @testcase: usage-pngquant-quality-high-png
# @title: pngquant high quality PNG
# @description: Exercises pngquant high quality png through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: pngquant
...
case_id="usage-pngquant-quality-high-png"
tmpdir=$(mktemp -d)
