#!/usr/bin/env bash
# @testcase: usage-pngquant-speed-three-png
# @title: pngquant speed three PNG
# @description: Exercises pngquant speed three png through a dependent-client usage scenario.
# @timeout: 120
# @tags: usage
# @client: pngquant
...
case_id="usage-pngquant-speed-three-png"
tmpdir=$(mktemp -d)
